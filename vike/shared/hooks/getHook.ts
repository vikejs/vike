...
import type { PageConfigsUserFriendly } from '../getPageFiles.js'
...
function getHook(pageContext: PageConfigsUserFriendly, hookName: HookName): null | Hook {
...
function assertHook<TPageContext extends PageConfigsUserFriendly, THookName extends PropertyKey & HookName>(
