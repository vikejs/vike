...
import type { PageConfigsUserFriendly, PageFile } from '../../shared/getPageFiles.js'
...
function populatePageContextPrefetchCache(
  pageContext: PageContextForPrefetch /*& PageConfigsUserFriendly*/,
  result: ResultPageContextFromServer
): void {
  // TODO/pageContext-prefetch: replace with using pageContext.config.prerender instead. (For being able to do that: eager configs need to be accessible without have to use PageConfigsUserFriendly as it isn't available here.)
