...
describe('getPrettyErrMessage()', () => {
  ...
  it('operations', () => {
    {
      const message = '/home/rom/code/vike/examples/react-full/components/Counter.tsx'
      const err = { message, id, frame }
      expect(getPrettyErrMessage(err)).toBe('')
    }
    {
      const message = '/home/rom/code/vike/examples/react-full/components/Counter.tsx:1:2: abc'
      const err = { message, id, frame }
  ...
  it('real use case - @vitejs/plugin-react (1)', () => {
    const message = `Transform failed with 1 error:
/home/rom/code/vike/examples/react-full/components/Counter.tsx:1:8: ERROR: Expected ";" but found "React"`
    const err = { message, id, frame }
    expect(getPrettyErrMessage(err)).toBe('')
  })
  ...
  it('real use case - @vitejs/plugin-vue', () => {
    const id = '/home/rom/code/vike/examples/vue-full/pages/index/+Page.vue'
