...
import type { ConfigVikeResolved } from '../plugin/plugins/importUserCode/v1-design/getVikeConfig/resolveVikeConfigGlobal.js'
...
function getRuntimeManifest(configVike: ConfigVikeResolved, viteConfig: ResolvedConfig): RuntimeManifest {
