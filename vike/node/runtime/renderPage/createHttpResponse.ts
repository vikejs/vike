...
function createHttpResponseError(): HttpResponse {
  const httpResponse = createHttpResponse(
    ...
    'text/html;charset=utf-8',
    [],
    `<p>An error occurred.</p><script>console.log('This HTTP response was generated by Vike. This response is used instead of rendering the error page (https://vike.dev/error-page), either because there is no error page or because an error occurred while rendering the error page.')</script>`
  )
  return httpResponse
}
