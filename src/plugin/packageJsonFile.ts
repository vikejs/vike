 ...
 *   require() of dist/server/pageFiles.node.js from node_modules/vite-plugin-ssr/dist/cjs/page-files/setup.node.js is an ES module file as it is a .js file whose nearest parent package.json contains "type": "module" which defines all .js files in that package scope as ES modules.
