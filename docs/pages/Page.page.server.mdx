...
What happens with the `Page` value is determined by the <UiFrameworkVikeExtension />. Alternatively, for complete control over the UI framework integration, you can <Link href="#manual-integration">manually integrate</Link> the UI framework yourself.
