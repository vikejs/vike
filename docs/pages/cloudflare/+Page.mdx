...
We recommend <Link href="#photon">using Photon</Link> to deploy your app to [Cloudflare](https://www.cloudflare.com).
...
> <UseScaffolder>Cloudflare (using Photon)</UseScaffolder>
