...
<Tabs>
  ...
  <TabPanel>
    ```shell
    npm i -D vike-cloudflare wrangler
    ```
  </TabPanel>
  <TabPanel>
    ```shell
    pnpm add -D vike-cloudflare wrangler
    ```
  </TabPanel>
  <TabPanel>
    ```shell
    yarn add -D vike-cloudflare wrangler
    ```
  </TabPanel>
</Tabs>
...
```json
{
  "scripts": {
    "dev": "vike dev",
    "preview": "vike build && wrangler pages dev", // [!code ++]
    "deploy": "vike build && wrangler pages deploy" // [!code ++]
  }
}
```
