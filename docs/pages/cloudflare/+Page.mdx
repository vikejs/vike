...
> For an example of how to access [Cloudflare D1](https://developers.cloudflare.com/d1/) during development, see <Link href="/new">`pnpm create vike@latest --react --hono --drizzle --cloudflare`</Link>.
