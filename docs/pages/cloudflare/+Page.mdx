...
The [`vike-cloudflare`](https://github.com/vikejs/vike-cloudflare) extension enables zero-config deployment of <Link href="/ssr">SSR</Link> as well as <Link href="/pre-rendering">pre-rendered (aka SSG)</Link> apps to Cloudflare.
