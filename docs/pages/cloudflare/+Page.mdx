...
It's recommended to move your server entry to `+server.ts` and use `vike/universal-middleware`.
...
Instead of using the native Vike integration, you can manually integrate your app with Cloudflare yourself.
