        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              ...
              <Column>
                ...
                <div style={{ display: 'flex', columnGap: 40, rowGap: 15, flexWrap: 'wrap' }}>
                  <div>
                    ...
                    <Check>Forever free</Check>
                    <Check>
                      <Link href="/pricing/accessible#limited-resources">Apply</Link> for free license key
                    </Check>
                  </div>
                  <div>
                    ...
                    <Check>
                      Free trial: 6 months + <Link href="/pricing/accessible#extended-free-trial">extendable</Link>
                    </Check>
                  </div>
                </div>
              </Column>
            ...
            <div style={{ marginLeft: 10, marginTop: 20 }}>
              ...
              <Note ref={3}>
                Organizations with <Link href="/pricing/accessible#limited-resources">few employees</Link> are
                considered resource-limited.
              </Note>
              <Note ref={4}>
