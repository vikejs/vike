...
Vike uses a novel business model: the Open Source Pricing. It's built on following principles:

- ✅ 100% open source (MIT License)
- ✅ 100% accessible: everyone can use Vike (regardless of financial resources)
- ✅ 100% aligned interesets (since Vike enough resouces via this business model)
