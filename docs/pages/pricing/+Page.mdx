...
<TeamQuote style={{marginTop: 42}} maxWidth={null}>We designed it to <Link href="#is-vike-still-free-software">preserve Open Source values</Link>, make Vike a <Link href="#why-zero-investors">sustainable tool</Link> you can trust and confidently build upon, and enable us to design the DX of the future.</TeamQuote>
