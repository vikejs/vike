...
For larger projects, Vike shows a pesky toaster `Get your license key at ...` that you can remove by purchasing a license key. (You can apply for a free license key if you have limited resources.) You install the key by running `$ vike add-key 4f7D-K1q2-9X5W-J6G3-b9t1`.
