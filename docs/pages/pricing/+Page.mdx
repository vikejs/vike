...
- ✅ **100% accessible**: everyone can use Vike (regardless of financial resources)
- ✅ **100% aligned interesets** for a framework you can trust (since Vike enough resouces via this business model)
