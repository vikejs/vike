...
<QuoteTeam style={{marginTop: 60, marginBottom: 45}}>Paying for Open Source isn't a bug — it's a feature: it ensures Vike's interests are aligned with yours.</QuoteTeam>
