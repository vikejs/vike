...
- Vike is free for large projects in their infancy. (With a 3-month free trial from the moment the projects starts having `>=3` regular committers.)
- Vike is free for finished projects. (That can be maintained for free with up to two full-time developers.)

If you are within the **free tier then you don't need any license key** and you can use Vike without any restrictions &mdash; just like any other open source tool. (See also <Link href="#how-does-it-work" />)
...
The table above is only a recommendation and you can choose any amount instead &mdash; we trust companies to make a fair choice. Keeping Vike accessible to everyone is a primary objective of the Open Source Pricing.

> **Don't hesitate to apply for a free license key** if you haven't incorporated yet, just want to experiment, or if you have a use case you believe should be free.
