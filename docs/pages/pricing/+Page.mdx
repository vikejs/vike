...
We believe in Libre Software and that's we invented the Open Source Pricing: <Link doNotInferSectionTitle href="#why-not-another-business-model" >other business models are fundamentally flawed</Link>.
