...
- **Regular committer**: developer who has committed regularly over the past three months.
- **Small use case**: Vike is used for developing a project that only plays a marginal role to your company. Example: landing page or a simple internal app.
- **Large use case**: Vike is used for developing a project that plays a central role to your company. Example: user-facing app that an app build Your Ow
- **Medium use case**: In-between, for examples a one-shot use for a complex internal app.
...
> **Don't hesitate to apply for a free license key** if this recommended sponsoring amount isn't affordable for you. Keeping Vike accessible for everyone is a central goal of the Open Source Pricing.
