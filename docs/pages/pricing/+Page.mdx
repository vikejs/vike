...
<QuoteTeam style={{marginTop: 60, marginBottom: 45}}>Paying for a framework isn't a bug, it's a feature: it's the guarantee the framework's interests are aligned with yours.</QuoteTeam>
