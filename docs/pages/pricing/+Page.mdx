...
<ExtraWidth>
  <TeamQuote style={{marginTop: 16}} maxWidth={723}>We designed it <Link href="#is-vike-still-free-software">to preserve Open Source values</Link>, while <Link href="#why-zero-investors">making Vike a sustainable tool you can trust</Link> and confidently build upon, as well as enabling us to design the DX of the future.</TeamQuote>
</ExtraWidth>
