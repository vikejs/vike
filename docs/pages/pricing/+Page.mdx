...
- ✅ **Fully accessible**: everyone can use Vike, including teams with limited resources
...
In theory, since Vike is 100% open source, you could fork it, remove the pesky toaster, and publish your own npm package. But maintaining a fork requires non-negligible effort &mdash; you might as well just <Link href="/pricing/gift">apply for a free license key</Link> instead.
