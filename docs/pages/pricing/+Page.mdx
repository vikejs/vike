...
<Construction>
The Open Source Pricing isn't implemented yet. Questions welcome at [#1932](https://github.com/vikejs/vike/discussions/1932).
</Construction>
...
- ✅ **Fully transparent**: financial incentives aligned with user satisfaction
...
In theory, since Vike is 100% open source, you could fork it, remove the pesky toaster, and publish your own npm package. But maintaining a fork requires non-negligible effort &mdash; you might as well just <Link href="/pricing/accessible">apply for a free license key</Link> instead.
