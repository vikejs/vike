...
- ✅ **Innovative**: Vike has the resources to help shape JavaScript's future

<TeamQuote style={{marginTop: 42}} maxWidth={null}>
It makes Vike a tool you can trust and rely on in the long term. We designed it with meticulous care to <Link href="#is-vike-still-free-software">preserve Open Source</Link> values.
</TeamQuote>
