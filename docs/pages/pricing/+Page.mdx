...
import { TeamQuote, ExtraWidth } from '../../components'
...
- ✅ **Fully accessible**: everyone can use Vike (for free if limited financial resources)
- ✅ **Fully transparent**: Vike's financial incentives are aligned with users' interests

<ExtraWidth>
  <TeamQuote style={{marginTop: 24}} maxWidth={723}>We designed it to <Link href="#is-vike-still-free-software">preserve Open Source values</Link>, while making Vike a <Link href="#why-zero-investors">sustainable tool you can trust</Link> and confidently build upon, as well as enabling us to design the DX of the future.</TeamQuote>
</ExtraWidth>
...
As a small team, you can use Vike just like any other open-source tool — 100% free, without any license key (zero encumbrance).
