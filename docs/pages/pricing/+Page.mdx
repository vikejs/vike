...
<ExtraWidth>
  <TeamQuote style={{marginTop: 24}} maxWidth={723}>We designed it to preserve Open Source values, while making Vike a sustainable tool you can trust and confidently build upon, as well as enabling us to design the DX of the future.</TeamQuote>
</ExtraWidth>
