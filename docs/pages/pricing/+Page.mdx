...
- ✅ **Community-driven**: priorities are and *remain* aligned with users' interests
- ✅ **Transparent**: Vike has clear and transparent incentives
- ✅ **Innovative**: resources to shape JavaScript's future with a relentless first-principle approach

<TeamQuote style={{marginTop: 42}} maxWidth={null}>
It's fundamental to Vike's stability, making Vike a tool you can trust and rely on in the long term. We designed it with meticulous care to <Link href="#is-vike-still-free-software">preserve Open Source values</Link>.
</TeamQuote>
