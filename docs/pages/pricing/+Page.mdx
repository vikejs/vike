...
The *Open Source Pricing* is a novel business model we designed to make Vike:

- ✅ **Open source**: 100% MIT licensed
- ✅ **Accessible**: everyone can use Vike (for free if limited financial resources)
- ✅ **Community-oriented**: Vike's priorities are and *remain* aligned with users' interests
- ✅ **Transparent**: Vike's incentives are clear
- ✅ **Innovative**: Shaping JavaScript's future with a relentless first-principle approach

<TeamQuote style={{marginTop: 42}} maxWidth={null}>
The Open Source Pricing is a fundamental pillar, making Vike a tool you can trust and build upon with confidence, carefully designed to <Link href="#is-vike-still-free-software">preserve Open Source values</Link>.
</TeamQuote>
