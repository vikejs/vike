...
> Small contributors that make only occasional commits (bots, designers, technical manager, ...) aren't counted as "regular committers".


### Recommendation

The table above is only a recommendation and you can choose any amount instead &mdash; we trust companies to make a fair choice.
