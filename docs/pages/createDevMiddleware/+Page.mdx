...
> You don't need `createDevMiddleware()` if you use <Link href="/server">`+server.js`</Link>. (You also don't need it if you fully <Link href="/pre-rendering">pre-render</Link> your app and therefore don't need a server.)
