...
TODO: highlight "← *User finally sees content*" in blue

| Time | SPA | SSR |
|------|-----|-----|
| **0s** | User visits page | User visits page |
| **1s** | HTML loads (empty) | HTML loads with content ← *User sees content* |
| **3s** | JavaScript downloads | JavaScript downloads |
| **5s** | JavaScript executes and renders content ← *User finally sees content* | JavaScript hydrates (makes content interactive) |
