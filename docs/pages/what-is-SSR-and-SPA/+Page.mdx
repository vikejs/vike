...
**SSR* (**S**erver-**s**ide **r**endering) denotes the practice of rendering components to HTML on the server-side and then hydrating them on the clinet-side .
