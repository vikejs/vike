...
> - **Future uncertainty**: Google may discontinue JavaScript execution as SSR has become ubiquitious (Google started JavaScript execution at a time when SSR wasn't as widespread as it is today).
>
...
> A more accurate term would be CSR (Client-Side Rendering), but "CSR" is rarely used while "SPA" is widely used in the web development community. That's why we use the term SPA throughout Vike's documentation.
