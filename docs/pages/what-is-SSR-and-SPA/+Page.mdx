...
| **1s** | HTML loads (empty) | HTML loads with content<br/><span style={{color: 'green'}}>✅ *User sees content*</span> |
| **3s** | JavaScript downloads | JavaScript downloads |
| **5s** | JavaScript executes and renders content<br/><span style={{color: 'green'}}>✅ *User sees content*</span> | JavaScript hydrates (makes content interactive) |
