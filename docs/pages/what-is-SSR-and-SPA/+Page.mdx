...
| **1s** | HTML loaded (empty) | HTML loaded with content<br/><span style={{color: 'green'}}>✅ *User sees content*</span> |
| **3s** | JavaScript downloaded | JavaScript downloaded |
| **5s** | JavaScript executed and rendered content<br/><span style={{color: 'green'}}>✅ *User sees content*</span> | JavaScript hydrated (made content interactive) |
