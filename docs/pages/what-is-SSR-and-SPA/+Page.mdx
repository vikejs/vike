...
| **1s** | HTML loads (empty content) | HTML loads with content <span style={{color: 'green'}}>✅ *User sees content*</span> |
| **3s** | JavaScript downloads | JavaScript downloads |
| **5s** | JavaScript executes and renders content <span style={{color: 'green'}}>✅ *User finally sees content*</span> | JavaScript hydrates (makes content interactive) |
