...
For example, we usually define a <Link text={<><code>render()</code> hook</>} href="/render" /> in `_default.page.server.js` in order to define how our pages are rendered to HTML.
