...
For example, we can define <Link text={<>the <code>render()</code> hook</>} href="/render" /> in `_default.page.server.js` in order to define how our pages are rendered to HTML.

```js
// /renderer/_default.page.server.js
// Environment: Node.js

// This `render()` hook applies to all pages
