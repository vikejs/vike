...
{<TODO_APPLY addendum={
  <>
    <br />
    <code>Extend period</code>: can be modified. For example, you can set it to the duration after which you expect to be able to easily afford a license key. You can apply again after the extended period ends.
  </>
} />}
