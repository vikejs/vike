...
{<TODO_APPLY addendum={
  <>
    <br />
    <code>Extend period</code>: can be modified. For example, you can set it to the expected duration after which you can easily afford a license key. You can apply again after the extended period ends.
  </>
} />}
