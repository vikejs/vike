...
<a
  href={
    "mailto:vike-gift-program@brillout.com" +
    "?subject=" + encodeURIComponent("Request: free forever") +
    "&body=" + encodeURIComponent(
      "Website: TODO/1\n\nBecause: TODO/2"
    )
  }
>
  {'vike-gift-program@brillout.com'}
</a>
...
<a
  href={
    "mailto:vike-gift-program@brillout.com" +
    "?subject=" + encodeURIComponent("Request: extended free trial") +
    "&body=" + encodeURIComponent(
