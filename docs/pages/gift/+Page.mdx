...
{<TODO_APPLY addendum={<><br/><code>Extend period</code>: can be modified — you can set it to the expected duration after which you believe you can easily afford purchasing a license key. You can apply again after the extended period finished.</>} />}
