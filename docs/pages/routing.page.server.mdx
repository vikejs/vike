...
We can also define so-called "Route Strings" and "Route Functions" in `.page.route.js` files.
...
We can use a Route Function to implement all kinds of advanced routing.
