...
Example: [GitHub > `Aslemammad/vite-plugin-cloudflare` > `examples/vike/`](https://github.com/Aslemammad/vite-plugin-cloudflare/tree/main/examples/vike).
...
Example:
 - [GitHub > `Immortalin/vike-cloudflare-pages-demo`](https://github.com/Immortalin/vike-cloudflare-pages-demo)
