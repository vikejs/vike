...
## Examples
 ...
 - React: <RepoLink path='/examples/cloudflare-workers-react-v1/' />
 - React + SSR Streaming: <RepoLink path='/examples/cloudflare-workers-react-full-v1/' />
 - Vue: <RepoLink path='/examples/cloudflare-workers-vue-v1/' />
...
We can also use [Cloudflare Pages](https://developers.cloudflare.com/pages/) to deploy our Vike app.

To deploy our SSR worker, we use a [Cloudflare Pages Function](https://developers.cloudflare.com/pages/platform/functions/).

<Warning>Cloudflare Pages Functions is [in beta](https://developers.cloudflare.com/pages/platform/functions/).</Warning>
...
Example: <RepoLink path='/examples/cloudflare-workers-react-full-v1#universal-fetch' />.
