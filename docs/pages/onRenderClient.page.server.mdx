import { HookTypeScriptHints, VikeExtensionUiFramework, VikeExtensionUiFrameworkNames } from '../components'
...
> If you use a <VikeExtensionUiFramework/>, then you don't need to define `onRenderClient()` as it's already defined by <VikeExtensionUiFrameworkNames />.
