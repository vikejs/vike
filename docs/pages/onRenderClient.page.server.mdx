import { HookTypeScriptHints, VikeExtensionsUiFrameworks, VikeExtensionsUiFrameworksNames } from '../components'
...
> If you use a <VikeExtensionsUiFrameworks/>, then you don't need to define `onRenderClient()` as it's already defined by <VikeExtensionsUiFrameworksNames />.
