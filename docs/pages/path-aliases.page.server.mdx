...
Example:
 - <RepoLink path='/examples/path-aliases-v1' />
...
>
> Path aliases must start with a special character so that Vike can distinguish between path alias imports and npm package imports. If it's an issue for you then elaborate your use case in a new [GitHub Discussion](https://github.com/vikejs/vike/discussions).

See also:
 - [Vite Docs > `resolve.alias`](https://vitejs.dev/config/shared-options.html#resolve-alias)
 - <RepoLink path='/examples/path-aliases-v1/vite.config.ts' />
...
See also:
 ...
 - <RepoLink path='/examples/path-aliases-v1/package.json' />
...
See also:
 ...
 - <RepoLink path='/examples/path-aliases-v1/tsconfig.json' />
