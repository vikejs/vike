...
> Keep in mind that some of your server files may not be processed by Vite,
...
> While your path aliases don't need to follow the `#` convention, they do need to start with a special character to distinguish them from npm package names.
>
> Vite-plugin-ssr needs to be able to distinguish between path alias imports and npm package imports. If it's an issue for you then elaborate your use case in a new [GitHub Discussion](https://github.com/brillout/vite-plugin-ssr/discussions).
