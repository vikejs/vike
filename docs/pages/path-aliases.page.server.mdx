...
>
> Path aliases must start with a special character so that vite-plugin-ssr can distinguish between path alias imports and npm package imports. If it's an issue for you then elaborate your use case in a new [GitHub Discussion](https://github.com/brillout/vite-plugin-ssr/discussions).
