...
You need to export an object with `sync` and/or `async` functions depending on which hooks you want to wrap:
- `sync` — wraps synchronous hooks
- `async` — wraps asynchronous hooks
