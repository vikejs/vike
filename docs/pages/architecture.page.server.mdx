...
import { JustAMiddleware, UiFrameworkVikeExtensionNamesEnglish } from '../components'
...
Vike extensions such as <UiFrameworkVikeExtensionNamesEnglish /> integrate UI frameworks so that you don't have to write the integration.
