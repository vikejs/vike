...
The <UiFrameworkVikeExtension plural /> integrate UI frameworks. But, if you want, instead of using <UiFrameworkVikeExtensionNames /> you can use the hooks `onRenderHtml()` and `onRenderClient()` for complete control over how pages are rendered.
