...
import { JustAMiddleware, VikeExtensionUiFrameworkNamesEnglish } from '../components'
...
Vike extensions such as <VikeExtensionUiFrameworkNamesEnglish /> integrate UI frameworks so that you don't have to write the integration.
