...
> The [version ranges](https://semver.npmjs.com) use the same syntax as the `dependencies` property of `pacakge.json`. (Vike uses the Node.js built-in package [`semver`](https://www.npmjs.com/package/semver).)
