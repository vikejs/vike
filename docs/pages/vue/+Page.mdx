...
Instead of using <Link href="/vike-vue">`vike-vue`</Link>, you can implement your own Vue integration for full control over Vue as well as Vue libraries.

<CustomIntegrationWarning uiFramework="vue" />

> You can use <Link href="/new/core">vike.dev/new/core</Link> to scaffold a Vike app that uses a manual Vue integration.
...
Official examples:
 ...
 - <RepoLink path="/examples/vue-minimal" /> - Minimal integration, using <Link href="/server-routing">Server Routing</Link>.
