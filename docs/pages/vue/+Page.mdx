...
Instead of using <Link href="/vike-vue">`vike-vue`</Link>, you can implement your own Vue integration for full control over Vue itself as well as Vue libraries.
