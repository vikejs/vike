...
We recommend using <Link href="/extensions">`vike-vue`</Link> which integrates [Vue](https://vuejs.org) in a full-fledged manner.

> <UseBatiHint note>`vike-vue`</UseBatiHint>
