...
Official examples:
 - <RepoLink href="/boilerplates/boilerplate-vue-ts" /> - Classic integration, using <Link href="/client-routing">Client Routing</Link>.
 - <RepoLink href="/examples/vue-minimal" /> - Minimalistic integration, using <Link href="/server-routing">Server Routing</Link>.
