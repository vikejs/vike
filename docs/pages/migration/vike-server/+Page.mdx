...
Make sure to upgrade `vike` to version `>=0.4.239`.
...
<Tabs>
  ...
  <TabPanel>
    ...
    import { apply } from 'vike-server/hono'// [!code --]
    import { serve } from 'vike-server/hono/serve'// [!code --]
  ...
  <TabPanel>
    ...
    import { apply } from 'vike-server/express'// [!code --]
    import { serve } from 'vike-server/express/serve'// [!code --]
  ...
  <TabPanel>
    ...
    import { apply } from 'vike-server/fastify'// [!code --]
    import { serve } from 'vike-server/fastify/serve'// [!code --]
  ...
  <TabPanel>
    ...
    import { apply } from 'vike-server/h3'// [!code --]
    import { serve } from 'vike-server/h3/serve'// [!code --]
  ...
  <TabPanel>
    ...
    import { apply } from 'vike-server/elysia'// [!code --]
    import { serve } from 'vike-server/elysia/serve'// [!code --]
