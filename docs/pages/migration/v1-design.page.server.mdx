...
The overall architecture stays the same: the V1 design is mostly about replacing `.page.js` files with `+` files: `+config.h.js`, `+Page.js`, `+route.js`, ...

The migration is straightforward and typically quick to implement. We encourage you to migrate sooner rather than later.
