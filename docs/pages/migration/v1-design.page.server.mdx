...
Despite being simple, the change adds new foundational features. If you're curious: <Link href="/why-the-v1-design" />
...
> For more information about `+` files such as `+config.js` and `+onRenderHtml.js`, see:
...
See <Link href="#examples" /> and [example of implementing a `config.renderMode`](https://github.com/brillout/vite-plugin-ssr/blob/79c2d9d614240160fa9f60f08dfd2b33cc5b3a27/examples/render-modes-v1/renderer/%2Bconfig.ts#L9).
