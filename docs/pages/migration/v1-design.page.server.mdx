...
See:
 - <Link href="#examples" />
 - [Advanced example of implementing `config.renderMode`](https://github.com/vikejs/vike/blob/01cc674498ea8baa289bfccb633d04b4d6cc7958/examples/render-modes/renderer/+config.h.ts#L10-L24)
