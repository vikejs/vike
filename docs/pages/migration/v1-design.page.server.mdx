...
Notable migrations:
 ...
 - Domain-driven file structure (that uses `filesystemRoutingRoot`)
   - [migrate /examples/file-structure-domain-driven/](https://github.com/brillout/vite-plugin-ssr/commit/09c47412f94af825c0b48ad4553a42e6896363b3#diff-fb554213bca0ce54bf15ec3d058d4a214ec35fc797bda13ed877d767244b875bL1)
