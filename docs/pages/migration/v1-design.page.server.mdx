...
See:
 - <Link href="#examples" />
 - [Advanced example of implementing `config.renderMode`](https://github.com/vikejs/vike/blob/0f2e5f088fec4f6381ab97e0d3c43022f31e8740/examples/render-modes/renderer/+config.h.ts#L10-L24)
...
For convenience, you can use <Link text={<code>meta</code>} href="/meta" /> in order to [create a new config `onBeforeRenderIsomorph: boolean`](https://github.com/vikejs/vike/blob/0f2e5f088fec4f6381ab97e0d3c43022f31e8740/examples/react-full/renderer/+config.h.ts#L14-L33) for a [page-per-page toggle](https://github.com/vikejs/vike/blob/0f2e5f088fec4f6381ab97e0d3c43022f31e8740/examples/react-full/pages/star-wars/@id/+onBeforeRenderIsomorph.ts).
