...
> Photon automatically picks up and uses `@photonjs/cloudflare`.

> See also: <Link href="/cloudflare#photon" />.
...
> Photon automatically picks up and uses `@photonjs/vercel`.

> See also: <Link href="/vercel#photon" />.

> See <Link href="/vercel#advanced-options" /> for configurations.
