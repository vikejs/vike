...
## 5. Replace `vike-cloudflare`

> This step is only required if you have `vike-cloudflare` installed
...
## 6. Replace `vite-plugin-vercel`

> This step is only required if you have `vite-plugin-vercel` installed
...
Then head to <Link href="/vercel#advanced-options" /> for additional advanced configurations.
