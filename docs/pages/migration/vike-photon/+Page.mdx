...
<Tabs>
  ...
  <TabPanel>
    ...
    // @docpress-uncomment import { apply } from 'vike-server/hono' // [!code --]
    // @docpress-uncomment import { serve } from 'vike-server/hono/serve' // [!code --]
  ...
  <TabPanel>
    ...
    // @docpress-uncomment import { apply } from 'vike-server/express' // [!code --]
    // @docpress-uncomment import { serve } from 'vike-server/express/serve' // [!code --]
  ...
  <TabPanel>
    ...
    // @docpress-uncomment import { apply } from 'vike-server/fastify' // [!code --]
    // @docpress-uncomment import { serve } from 'vike-server/fastify/serve' // [!code --]
  ...
  <TabPanel>
    ...
    // @docpress-uncomment import { apply } from 'vike-server/h3' // [!code --]
    // @docpress-uncomment import { serve } from 'vike-server/h3/serve' // [!code --]
  ...
  <TabPanel>
    ...
    // @docpress-uncomment import { apply } from 'vike-server/elysia' // [!code --]
    // @docpress-uncomment import { serve } from 'vike-server/elysia/serve' // [!code --]
