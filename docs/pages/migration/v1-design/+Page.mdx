...
// @detype-uncomment export { render } // [!code --]
// @detype-uncomment export { render as onRenderClient } // [!code ++]
```
...
// @detype-uncomment export { render } // [!code --]
// @detype-uncomment export { render as onRenderHtml } // [!code ++]
```
...
// @detype-uncomment export { onBeforeRender }
...
// @detype-uncomment export { clientRouting }
// @detype-uncomment export { hydrationCanBeAborted }
```
</FileRemoved>
<FileAdded>
```ts
...
// @detype-uncomment export default route
```
