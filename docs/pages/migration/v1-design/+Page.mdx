...
See:
 - <Link href="#examples" />
 - [Advanced example of implementing `config.renderMode`](https://github.com/vikejs/vike/blob/0f2e5f088fec4f6381ab97e0d3c43022f31e8740/examples/render-modes/renderer/+config.ts#L10-L24)
