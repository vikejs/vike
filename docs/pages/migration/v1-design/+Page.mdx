...
```ts
// /renderer/_default.page.client.ts // [!code --]
// /renderer/+onRenderClient.ts // [!code ++]

// @docpress-uncomment export { render } // [!code --]
// @docpress-uncomment export { render as onRenderClient } // [!code ++]
```

```ts
// /renderer/_default.page.server.ts // [!code --]
// /renderer/+onRenderHtml.ts // [!code ++]

// @docpress-uncomment export { render } // [!code --]
// @docpress-uncomment export { render as onRenderHtml } // [!code ++]
```
...
```ts
// /renderer/_default.page.server.ts // [!code --]
// /renderer/+onBeforeRender.ts // [!code ++]

// @docpress-uncomment export { onBeforeRender }
...
Move `/renderer/` configurations to `/renderer/+config.js`:

<FileRemoved>
```ts
// /renderer/_default.page.client.ts

// @docpress-uncomment export { clientRouting }
// @docpress-uncomment export { hydrationCanBeAborted }
```
</FileRemoved>
<FileAdded>
```ts
...
```ts
// /renderer/_error.page.ts // [!code --]
// /pages/_error/+Page.ts // [!code ++]

// @docpress-uncomment export { Page }
```
...
```ts
// /pages/some-page/index.page.ts // [!code --]
// /pages/some-page/+Page.ts // [!code ++]

// @docpress-uncomment export { Page }
```
```ts
// /pages/some-page/index.page.server.ts // [!code --]
// /pages/some-page/+onBeforeRender.ts // [!code ++]

// @docpress-uncomment export { onBeforeRender }
```

```ts
// /pages/some-page/index.page.route.ts // [!code --]
// /pages/some-page/+route.ts // [!code ++]

// @docpress-uncomment export default route
```
