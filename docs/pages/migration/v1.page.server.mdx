1. Update to the latest `0.4.x` version, follow the deprecation warnings, and apply the instructions of how to update outdated code. (TODO/v1-release: replace `x` with actual version number.)
