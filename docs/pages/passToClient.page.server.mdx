...
Usually, `passToClient` is used with <Link text={<code>onBeforeRender()</code>} href="/onBeforeRender" /> for fetching data, see example at <Link href="/data-fetching#onbeforerender" />.
