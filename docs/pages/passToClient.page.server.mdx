...
See [`brillout/json-s` - Support user-defined classes (#3)](https://github.com/brillout/json-s/issues/3) if you need your classes to be preserved upon serialization.
