...
> **Edit for reddit folks**. [Vike](/) (with **k**) is a framework like Next.js/Nuxt which is built on top of [Vite](https://vite.dev) (with **t**) which is a bundler like webpack. Both projects are unaffiliated (atlthough we often collaborate).
