...
> **Edit for reddit folks**: Vi**k**e is a framework (like Next.js/Nuxt) built on top of Vi**t**e (a bundler like webpack). Both projects are unaffiliated (atlthough we occasionally collaborate).
