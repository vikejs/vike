...
In other words, you will develop code that works equally well between dev and prod. You'll get a unified stack between dev and prod.

This is major milestone for edge deployment, as you will develop for the edge as conveniently as for a Node.js/Bun/Deno server.
...
We're making a lot of progress and we'll probably release something this year.
