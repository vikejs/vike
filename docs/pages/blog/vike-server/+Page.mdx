...
> Unsurprisingly, having server code being transpiled by Vite was one of the most asked feature requests. In fact, this was the last piece about Vike we were (quite) ashamed of, and the main blocker for releasing `1.0` — we're now a lot <Link href="#releasing-1-0">closer to releasing `1.0`</Link>!
...
> Vike as well as Vike extensions are automatically added to your server.
...
We are a lot closer to releasing `1.0`. Our roadmap is:
 ...
 - Lot's of polishing. (This will introduce a lot of small breaking changes, but nothing complicated.)
