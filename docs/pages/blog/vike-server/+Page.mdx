...
> Unsurprisingly, having server code transpiled by Vite was one of the most requested features. In fact, this was Vike's last significant shortcoming and the main blocker for releasing `1.0` — we're now a lot <Link href="#releasing-1-0">closer to releasing `1.0`</Link>!
