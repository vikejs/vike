...
We (<Link href="/team">Joël, Dani, and Rom</Link>) have been working on a <Link href="/server">new Vike extension `vike-server`</Link> that can integrate Vite with any server (Express.js, Hono, Fastify, Elysia, H3, ...) and any deployment (VPS, Netlify, Cloudflare, Vercel, ...).
...
We've been beta testing it for many months and it's now stable and released as `1.0.0` — you can use it in production.
