...
We don't know how the shared deployment infrastructure problem will evolve. The best outcome, if possible, is that we move some — ideally most — of Photon's logic to Vite and its ecosystem (see [Netlify's RFC](https://github.com/vitejs/vite/discussions/20907)).
