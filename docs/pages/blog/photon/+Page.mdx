...
As we developed `vike-server`, we realized most of the code is agnostic to Vike. It became clear that we can (and should!) decouple the code from Vike with a minimal amount of glue code.
