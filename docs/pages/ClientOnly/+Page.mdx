...
import { UiFrameworkExtension, ConfigSpec, TreeShaking } from '../../components'

<ConfigSpec
  env="client, server"
  providedByExtension={{ kind: 'component', name: '<ClientOnly>' }}
  global={null}
/>
...
// ✅ Doesn't throw error "window is not defined" — this file is loaded only on the client
