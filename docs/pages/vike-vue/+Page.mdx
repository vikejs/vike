...
`vike-vue` is a <Link href="/extensions">Vike extension</Link> that integrates [Vue](https://vuejs.org) in a full-fledged manner, providing a DX like a regular frontend framework such as Nuxt.
