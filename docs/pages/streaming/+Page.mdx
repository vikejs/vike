...
> **What is HTML Streaming?** If you're unfamiliar with HTML streaming then check out [Dan Abramov's explanation of SSR, HTML streaming, and Progressive Rendering](https://github.com/reactwg/react-18/discussions/37). (While it explains it in the context of React, we still recommend it if you use another UI framework.)
