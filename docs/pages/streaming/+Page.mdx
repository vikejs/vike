...
import { UseVikeExtensionUiFramework, UiFrameworkVikeExtensionNames } from '../../components'
...
<Warning>The documentation on this page is meant for expert users who want to manually integrate HTML Streaming. If you use <UiFrameworkVikeExtension name /> then HTML Streaming is already built-in and you can skip reading this page.</Warning>
