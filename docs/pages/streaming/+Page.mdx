...
Some UI frameworks, such as React, support *progressive rendering*: while some parts of the UI are being loaded, other parts are already rendered (as well as already <Link href="/hydration">hydrated</Link>).
