...
> There are [more debug flags](https://github.com/vikejs/vike/blob/main/packages/vike/src/utils/debug.ts) but note that they are meant for Vike maintainers. Feel free to reach out if you want more debug logs.
