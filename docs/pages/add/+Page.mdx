...
- With or without <UiFrameworkExtension name noLink links list={['vike-react', 'vike-vue']} />.
...
You can choose whether you want to migrate towards a full-fledged SSR/SSG framework DX (like Next.js and Nuxt by using <UiFrameworkExtension name noLink links />), or add a minimal SSR/SSG implementation (applying a minimal amount of changes to your existing code), or something in-between.
...
3. Either:
   - Use <UiFrameworkExtension name noLink links />, or
