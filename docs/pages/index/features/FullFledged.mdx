...
The old project's website, `https://vite-plugin-ssr.com`, is HTML-only and loads only few KBs of JavaScript (which implements the few bits of interactivity such as
the collapsible `LEARN MORE` sections).
