...
For example, you can render your admin panel as SPA while rendering your marketing pages to HTML-first.

### HTML Streaming

HTML Streaming is the future and `vite-plugin-ssr` is the first SSR tool with first-class support for HTML Streaming.
