...
Not only can you integrate any tool you want, but integration is also simple: `vite-plugin-ssr` gets out of your way and you can simply follow the tool's official bare installation guide.
