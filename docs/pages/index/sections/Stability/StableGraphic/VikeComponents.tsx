...
const VikeComponents = () => {
  return (
    <div className="relative overflow-hidden rounded-[1.75rem] border border-secondary/15 bg-linear-to-b from-white via-white to-secondary/6 px-3 pb-3 pt-18 shadow-[0_20px_70px_-40px_rgba(37,99,235,0.45)] md:mx-auto md:w-[92%] md:px-4 md:pb-4 md:pt-20">
