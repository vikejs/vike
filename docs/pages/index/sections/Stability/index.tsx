      ...
      <div className="w-full">
        <LayoutComponent>
          ...
          <LayoutComponent $size="sm" className="mb-8 md:w-3/4 lg:w-2/3 mx-auto">
            <p>
              Vike's internal components are <b className="font-semibold">stable primitives</b> remaining relevant for
              the foreseeable future.{' '}
              <b className="font-normal">Unstable and/or fast-evolving tools aren't built into Vike by design</b> —
              instead, Vike extensions provide first-class deep integrations.
            </p>
          </LayoutComponent>
          <StableGraphic />
        </LayoutComponent>
