      ...
      <StyledOuter ref={containerRef}>
        ...
        >
          ...
          <g ref={onRenderClientRef} {...getHoverHandlers('onRenderClient')}>
            <rect fill={hookColors.onRenderClient} width={pinWidth} height={pinHeight} x="70" y="208" />
            <path stroke={hookColors.onRenderClient} strokeWidth={strokeWidth} d="M76 130V210" />
            {/* outwards circuit */}
            <g>
              <path
                stroke={hookColors.onRenderClient}
                strokeWidth={strokeWidth}
                d="M34.5 165.5C36.15685 165.5 37.5 166.843 37.5 168.5C37.5 170.157 36.15685 171.5 34.5 171.5C32.84314 171.5 31.5 170.157 31.5 168.5C31.5 166.843 32.84315 165.5 34.5 165.5Z"
              />
              <path stroke={hookColors.onRenderClient} strokeWidth={strokeWidth} d="M75 168.5L37.77758 168.5" />
            </g>
          </g>

          {/* onRenderHtml */}
          <g ref={onRenderHtmlRef} {...getHoverHandlers('onRenderHtml')}>
            <path stroke={hookColors.onRenderHtml} strokeWidth={strokeWidth} d="M96 130V210" />
            <rect fill={hookColors.onRenderHtml} x="90" y="208" width={pinWidth} height={pinHeight} />
          </g>

          {/* onAfterRenderHtml */}
          <g ref={onAfterRenderHtmlRef} {...getHoverHandlers('onAfterRenderHtml')}>
            <rect fill={hookColors.onAfterRenderHtml} x="150" y="130" width={pinWidth} height={pinHeight} />
            <path
              stroke={hookColors.onAfterRenderHtml}
              strokeWidth={strokeWidth}
          ...
          <g ref={onBeforeRenderHtmlRef} {...getHoverHandlers('onBeforeRenderHtml')}>
            <rect fill={hookColors.onBeforeRenderHtml} x="170" y="130" width={pinWidth} height={pinHeight} />
            <path
              stroke={hookColors.onBeforeRenderHtml}
              strokeWidth={strokeWidth}
          ...
          <g ref={wrapperRef} {...getHoverHandlers('Wrapper')}>
            <rect fill={hookColors.Wrapper} x="190" y="130" width={pinWidth} height={pinHeight} />
            <path
          ...
          <g ref={onErrorRef} {...getHoverHandlers('onError')}>
            <rect fill={hookColors.onError} x="150" y="208" width={pinWidth} height={pinHeight} />
            <path
              stroke={hookColors.onError}
              strokeWidth={strokeWidth}
          ...
          <g ref={onCreateGlobalContextRef} {...getHoverHandlers('onCreateGlobalContext')}>
            <rect fill={hookColors.onCreateGlobalContext} x="130" y="208" width={pinWidth} height={pinHeight} />
            <path
              stroke={hookColors.onCreateGlobalContext}
              strokeWidth={strokeWidth}
          ...
          <g ref={headRef} {...getHoverHandlers('Head')}>
            <rect fill={hookColors.Head} x="110" y="130" width={pinWidth} height={pinHeight} />
            <path
              stroke={hookColors.Head}
              strokeWidth={strokeWidth}
          ...
          <g ref={onHookCallRef} {...getHoverHandlers('onHookCall')}>
            <rect fill={hookColors.onHookCall} x="170" y="208" width={pinWidth} height={pinHeight} />
            <path
              stroke={hookColors.onHookCall}
              strokeWidth={strokeWidth}
          ...
          <g ref={onBeforeRenderClientRef} {...getHoverHandlers('onBeforeRenderClient')}>
            <rect fill={hookColors.onBeforeRenderClient} x="130" y="130" width={pinWidth} height={pinHeight} />
            <path
              stroke={hookColors.onBeforeRenderClient}
              strokeWidth={strokeWidth}
          ...
          <g ref={onCreatePageContextRef} {...getHoverHandlers('onCreatePageContext')}>
            <rect fill={hookColors.onCreatePageContext} x="190" y="208" width={pinWidth} height={pinHeight} />
            <path
              stroke={hookColors.onCreatePageContext}
              strokeWidth={strokeWidth}
            ...
            /> */}
            {/* <path stroke={hookColors.onCreatePageContext} strokeWidth={strokeWidth} d="M235.5 241L235.5 341.197" /> */}
          </g>
        </svg>
      </StyledOuter>
