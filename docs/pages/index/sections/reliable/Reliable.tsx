...
const benefits = [
  {
    ...
    href: '/pricing',
    description:
      "Vike's pricing keeps code 100% open source (MIT licence) and 100% free for engineers while asking companies to pay a small amount, for a transparent and sustainable relationship.",
