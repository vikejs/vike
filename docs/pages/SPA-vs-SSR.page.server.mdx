...
We compare render modes and explain when to use each mode.

> See <Link href="/render-modes" /> for how to use render modes with your Vike app.
...
SSR means that our page is rendered to HTML as well as rendered (hydrated) in the browser.
...
Examples:
 ...
 - Portfolio/homepage
 - Marketing pages
 - Software Documentation (e.g. `https://vike.dev`)
...
This is what `https://vike.dev` does: if we inspect the browser-side JavaScript of this page, we'll see only around 1-2KB of JavaScript.
