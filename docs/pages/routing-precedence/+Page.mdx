...
> You can find more examples at [`resolvePrecedence_route-strings.spec.ts`](https://github.com/vikejs/vike/blob/main/packages/vike/src/shared-server-client/route/resolvePrecedence/resolvePrecedence_route-strings.spec.ts).
...
> More examples at [`resolvePrecedence_overall.spec.ts`](https://github.com/vikejs/vike/blob/main/packages/vike/src/shared-server-client/route/resolvePrecedence/resolvePrecedence_overall.spec.ts).
