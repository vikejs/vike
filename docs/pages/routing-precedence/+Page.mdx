...
> More examples at [`resolvePrecedence_route-strings.spec.ts)](https://github.com/vikejs/vike/blob/main/vike/shared/route/resolvePrecedence/resolvePrecedence_route-strings.spec.ts).
...
1. Route String, parameterized (i.e. with `@param` segment, e.g. `/product/@productId` or `/product/*`)
...
> More examples at [`resolvePrecedence_overall.spec.ts`](https://github.com/vikejs/vike/blob/main/vike/shared/route/resolvePrecedence/resolvePrecedence_overall.spec.ts).
