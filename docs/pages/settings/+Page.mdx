...
> You can create your own document metadata settings, see <Link href="/head-tags#custom-settings" />.

> These settings below can be set via `useConfig()`, `<Config>`, or `<Head>`. See <Link href="/useConfig"/>.
