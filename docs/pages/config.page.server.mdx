...
> `config.title` is provided by the <Link text="UI framework integration" href="/vike-packages#ui-frameworks" />. If you don't use a integration package you can define `config.title` yourself, see <Link href="/meta" />.
