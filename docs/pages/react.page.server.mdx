...
Vike supports <Link href="/streaming#progressive-hydration">Progressive Hydration</Link> as well as <Link href="/RPC">Server Actions</Link>. Server Components is work-in-progress.
