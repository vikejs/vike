...
Vike supports <Link href="/streaming#progressive-rendering">Progressive Rendering</Link> as well as <Link href="/RPC">Server Actions</Link>. Server Components is work-in-progress.
