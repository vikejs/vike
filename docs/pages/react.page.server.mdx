import { UseVikeExtensionsUiFrameworksHint, Example } from '../components'
import { Link } from '@brillout/docpress'

## Vike Extension

<UseVikeExtensionsUiFrameworksHint uiFrameworkName="React" noQuote={true} />
...
Vike supports <Link href="/stream#progressive-hydration">Progressive Hydration</Link> as well as <Link href="/RPC">Server Actions</Link>. Server Components is work-in-progress.
