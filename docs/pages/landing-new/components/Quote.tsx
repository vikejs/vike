...
interface QuoteSvgIconProps {
  className?: string
}

const QuoteSvgIcon = ({ className }: QuoteSvgIconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58.092 51" className={cmMerge("w-10 h-10 text-grey-200", className)}>
    <g fill="currentColor">
...
const Blockquote = ({ children, authorPictures, className, ...props }: QuoteProps) => {
  return (
    <div className={cmMerge('flex flex-col md:flex-row items-center gap-3 justify-between px-4 md:px-0', className)} {...props}>
