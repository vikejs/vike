...
export const landingPageHeroUsps: Usp[] = [
  {
    ...
    title: 'Freedom',
    description: 'Build what you want with unprecedented flexibility.',
    icon: '🕊️',
    dotColor: 'green',
  },
  {
    ...
    title: 'Stability',
    description: 'Build on top of a stable foundation you can rely on.',
    icon: '💎',
    dotColor: 'blue',
  },
  {
    ...
    title: 'Lightning DX',
    description: 'Experience state-of-the-art as well as new DX.',
    icon: '⚡️',
    dotColor: 'orange',
  },
]
