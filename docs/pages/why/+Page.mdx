...
This flexibility is powered by **low-level APIs**.
...
Vike's architectural freedom is also important in the sense that it enables you to continuously and progressively adapt your stack the your evolving needs with need to costly framework migration.

> For example, you may start with an SPA and later realize that you need SSR; Vike enables you to easily add SSR to an exsiting SPA.
