...
With Vike, you have architectural freedom and can choose any deployment strategy, any backend, any data-fetching method, and any UI tool.

> You can choose any of the following architecture and tools.
