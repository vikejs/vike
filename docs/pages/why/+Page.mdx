...
Rationale for using Vike. This page is technical, see the <Link href="/">landing page</Link> for a less technical introduction to Vike.


## Flexible

Vike is designed from the ground up to be flexible, so that it can adopt your company requirements.
