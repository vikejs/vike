...
Vike is an independent project 100% led by engineers with a clear plan and long-term vision.

Thanks to Vike's <Link href="/why#next-generation-business-model">Open Source Pricing</Link> we don't serve the agenda of any unrelated business: we only serve the interests of our users.
