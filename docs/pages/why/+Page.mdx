...
Not only is Vike flexible by design, but it's also flexible by prioritization: if you create a feature requests and you explain why not having this feature is blocking then we'll treat your request with higher priority.

We also quickly fix bugs (usually under 24 hours) also because bugs are often blockers.
