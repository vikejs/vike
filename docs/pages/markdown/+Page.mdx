...
The preferred technique depends on whether you want to defined global or local metadata.

#### Global metadata

> **What is global metadata?** For example, if you're showing a list of all your blog posts, and you want to always show that list on the left side of your website.
> ```
> 2024-01-01 New Year 2024 Resolution
> 2023-12-20 Wrapping up 2023
> 2023-06-15 My summer 2023
> ```
> Because this list is shown on the left of every page, the publishing date and the title of all blog posts is needed for rendering any page: the metadata needs to be accessible *globally*.
...
#### Local metadata
 ...
 > **What is local metadata?**  For example, if you want to show detailed information below a blog post such as the author's name. This metadata is only shown for that one page and, therefore, it's and only needed for rendering that page: the metadata needs to be accessible only *locally*.
