...
>
> For [files not processed by Vite](https://github.com/brillout/vite-plugin-ssr/issues/562), you need to manually install [dotenv](https://github.com/motdotla/dotenv) for your `.env` values to also be available in files that aren't processed by Vite.
