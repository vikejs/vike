...
By default, Vike does <Link text="Server Routing" href="/server-routing" /> but you can opt into <Link text="Client Routing" href="/client-routing" /> by:
...
<UseIntegrationPackageAnyHint featureName="Client Routing" />
...
React example:
 - <RepoLink path='/examples/react-full/renderer/+onRenderClient.tsx' />
 - <RepoLink path='/examples/react-full/pages/index/+Page.tsx' /> (example of using <Link href="#programmatic-navigation">`navigate()`</Link>)

Vue example:
 - <RepoLink path='/examples/vue-full/renderer/+onRenderClient.ts' />
 - <RepoLink path='/examples/vue-full/renderer/app.ts' />
 - <RepoLink path='/examples/vue-full/pages/index/+Page.vue' /> (example of using <Link href="#programmatic-navigation">`navigate()`</Link>)
...
- `hydrationCanBeAborted`: Whether the <Link text="UI framework" href="/ui-framework" /> allows <Link href="/hydration">hydrations</Link> to be aborted, see <Link href="/hydrationCanBeAborted" />.
- `<a keep-scroll-position>`: By default, the Client Router scrolls to the top of the page upon page change; you can use `<a href="/some/url" keep-scroll-position />` if you want to preserve the scroll position instead. (Useful for <Link text="Nested Layouts" href="/layouts#nested-layouts" />.)
- `<a rel="external">`: Skip Client Routing, see <Link href="#links-intercepting" />.
