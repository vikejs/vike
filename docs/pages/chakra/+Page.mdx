...
If you are using <Link href="/vike-react">vike-react</Link>, you can install [`vike-react-chakra`](https://github.com/vikejs/vike-react/tree/main/packages/vike-react-chakra#readme) for a seamless integration.
