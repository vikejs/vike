...
> If you use <Link href="/vike-photon">`vike-photon`</Link>, you can access the request object at `pageContext.runtime.req.user` (see <Link href="/pageContext#runtime">`pageContext.runtime`</Link>).
>
