...
export async function onCreatePageContext(pageContext: PageContextServer) {
  // The request object is available at pageContext.runtime.req
...
> See also: <Link href="/pageContext#runtime">API > `pageContext.runtime`</Link>
...
> If you use <Link href="/server">`+server.js`</Link>, you can access the request object at <Link href="/server#pagecontext-runtime">`pageContext.runtime.req`</Link> (or its alias <Link href="/pageContext#req">`pageContext.req`</Link>).
>
