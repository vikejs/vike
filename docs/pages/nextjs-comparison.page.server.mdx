...
VPS (vite-plugin-ssr) differs from Next.js in three fundamental ways:
 ...
 1. VPS is full-fledged yet minimal.
    > [All dependencies](https://github.com/brillout/vite-plugin-ssr/blob/89073c8375d46af7cc05057a8f2efcd833273be6/vite-plugin-ssr/package.json#L4-L13) are either shared with Vite (such as [`fast-glob`](https://github.com/mrmlnc/fast-glob) or fully owned (such as [`@brillout/json-serializer`](https://github.com/brillout/json-serializer)). I.e. adding VPS to your Vite app doesn't add any dependency (that we don't fully own, transitively so).
    >
