...
| Image component                                                 | No*, use a Vite plugin like:<ul><li> [vite-imagetools](https://github.com/JonasKruckenberg/imagetools) </li><li>[vite-plugin-image-presets](https://github.com/ElMassimo/vite-plugin-image-presets)</li></ul>See [awesome-vite](https://github.com/vitejs/awesome-vite).                                                         | Yes, next/image               |
