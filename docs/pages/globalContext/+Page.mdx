...
> In development, the `globalContext` object is re-initialized if you make a file change that triggers a full page reload (in other words, a file change that isn't covered by HMR).
