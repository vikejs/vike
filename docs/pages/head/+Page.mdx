...
- Use the Vike settings `title` and `description`, and `lang`
- The `Head` setting for other `<head>` tags
- The `useConfig()` hook to set component 
- 
...
, such as `<title>` and `<meta name="description">`, you can use:
