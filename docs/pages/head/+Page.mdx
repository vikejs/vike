...
Let's see how the settings above are typically used.
...
// Set some defaults (some pages will override them)
export default {
  // Default <title>
...
You can override the defaults, on a page-by-page basis:

```js
// pages/rocket/starship/+title.js

// Overrides the title defined at pages/+config.js
export const title = 'Rocket: Starship'
```
```js
// pages/rocket/falcon-9/+title.js

// Overrides the title defined at pages/+config.js
export const title = 'Rocket: Falcon 9'
```
