...
> See also:
> - <Link href="/htmlAttributes">`htmlAttributes`</Link> to add tag attributes such as `<html class="dark">`.
> - <Link href="/bodyAttributes">`bodyAttributes`</Link> to add tag attributes such as `<body class="dark">`.
