...
> If we use <Link href="/extensions#ui-framework">`vike-react`</Link>, then we can use its <Link href="/usePageContext">`usePageContext`</Link> hook.
...
> If we use <Link href="/extensions#ui-framework">`vike-vue`</Link>, then we can use its <Link href="/usePageContext">`usePageContext`</Link> hook.
