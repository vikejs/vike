...
Example:
 - [/boilerplates/boilerplate-vue/renderer/app.js (@abff8de)](https://github.com/brillout/vike/blob/abff8debc4c7cd6ab11e99e757379e5237a6c18c/boilerplates/boilerplate-vue/renderer/app.js#L26)
   (`app.config.globalProperties.$pageContext = pageContext`)
 - [/boilerplates/boilerplate-vue/renderer/Link.vue (@abff8de)](https://github.com/brillout/vike/blob/abff8debc4c7cd6ab11e99e757379e5237a6c18c/boilerplates/boilerplate-vue/renderer/Link.vue#L2)
...
If we use <Link href="/client-routing" noBreadcrumb={true} />, we make `$pageContext` reactive:
 - [/examples/vue-full/renderer/app.ts (@aca560b)](https://github.com/brillout/vike/blob/aca560bd286b37524b4164555e5ab3f77e3688af/examples/vue-full/renderer/app.ts#L43-L47)
