...
> If we use <Link href="/vike-packages#ui-frameworks">`vike-react`</Link>, then we can simply use the <Link href="/usePageContext">`usePageContext`</Link> hook instead.
...
> If we use <Link href="/vike-packages#ui-frameworks">`vike-vue`</Link>, then we can simply use the <Link href="/usePageContext">`usePageContext`</Link> hook instead.
