...
Using Vike with [`styled-jsx`](https://github.com/vercel/styled-jsx).
...
3. Collect and inject styles.
   > When using a CSS-in-JS tool, like `styled-jsx`, you always need to collect the page's styles upon SSR in order <Link href="/css-tools#collect-styles-upon-ssr">to avoid FOUC</Link>.

   > If you use <UiFrameworkExtension name />, then see <Link href="/css-tools#collect-styles-upon-ssr" doNotInferSectionTitle />.
