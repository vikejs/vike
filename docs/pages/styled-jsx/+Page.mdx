...
Example of using Vike with `styled-jsx`:
 - <Example timestamp="2024.12" repo="phonzammi/vike-react-styled-jsx-example" /> - Using <Link href="/vike-react">`vike-react`</Link>

## Without `vike-{react,vue,solid}`

To use Vike with `styled-jsx` without <UiFrameworkExtension />:
