...
You can choose whether you want to migrate towards a full-fledged SSR/SSG framework DX (similar to Next.js and Nuxt by using <UiFrameworkVikeExtensionNames links />), or add a minimal SSR/SSG implementation (applying a minimal amount of changes to your existing code), or something in-between.
