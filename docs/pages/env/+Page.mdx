...
// The UI compnent <ContactUs> is loaded on the client-side
...
<Contribution>
  Contributions welcome to [add entries to the `PUBLIC_ENV_ALLOWLIST` list](https://github.com/vikejs/vike/blob/main/packages/vike/node/vite/plugins/pluginReplaceConstantsEnvVars.ts).
</Contribution>
