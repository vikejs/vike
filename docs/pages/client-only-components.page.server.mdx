...
> If you use [`vike-react`](https://github.com/vikejs/vike-react), then you can use its built-in <Link href="/ClientOnly">`<ClientOnly>`</Link> implementation.
...
> If you use [`vike-solid`](https://github.com/vikejs/vike-solid), then you can use its built-in <Link href="/ClientOnly">`<ClientOnly>`</Link> implementation.
