...
> If you use [`vike-vue`](https://github.com/vikejs/vike-vue), then you can use its built-in <Link href="/ClientOnly">`<ClientOnly>`</Link> implementation.

### Example

An example can be found at [Github > `vike-vue`](https://github.com/vikejs/vike-vue/blob/main/examples/basic/pages/client-only/%2BPage.vue)
