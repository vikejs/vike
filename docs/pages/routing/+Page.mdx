...
FILESYSTEM                     URL
========================       =======================
pages/movie/@id/+Page.ts       /movie/1, /movie/2, ...
```
...
FILESYSTEM                             URL
================================       ==================
pages/(marketing)/index/+Page.ts       /
pages/(marketing)/about/+Page.ts       /about
pages/admin-panel/index/+Page.ts       /admin-panel
pages/admin-panel/users/+Page.ts       /admin-panel/users
```
...
pages/(marketing)/+Layout.ts
pages/(marketing)/index/+Page.ts
pages/(marketing)/about/+Page.ts

# Define a layout for all admin pages
pages/admin-panel/+Layout.ts
pages/admin-panel/index/+Page.ts
...
```yaml
# Domain: marketing
(marketing)/pages/+Layout.ts
(marketing)/pages/index/+Page.ts
(marketing)/pages/about/+Page.ts
(marketing)/components/ContactUs.ts

# Domain: admin panel
admin-panel/pages/+Layout.ts
admin-panel/pages/index/+Page.ts
admin-panel/pages/users/+Page.ts
admin-panel/components/Charts.ts
admin-panel/database/fetchUsers.ts
```
