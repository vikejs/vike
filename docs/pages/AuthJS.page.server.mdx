...
[Auth.js](https://authjs.dev/) (previously known as NextAuth.js) can be used with `vike`.
...
> We can use `process.env` as usual for server (e.g. Express.js) code. (Since [server code isn't processed by Vite](https://github.com/brillout/vike/issues/562).)
