...
The `injectFilter()` hook allows you to control which and where preload/asset tags are injected in the HTML.

See <Link href="/preload" />.

## Examples

 - <Link href="/examples/custom-preload-v1/renderer/+onRenderHtml.tsx" />
 - <Link href="/test/preload-v1/renderer/+onRenderHtml.tsx" />
