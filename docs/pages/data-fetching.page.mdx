import { RepoLink, DocLink } from 'libframe-docs/components'
...
If we use the same data fetching logic for all/several pages we can factor out common code.
...
See <DocLink href="/onBeforeRender-multiple" />.
