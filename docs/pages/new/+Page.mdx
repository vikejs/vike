...
You can also create a new Vike app that doesn't use <UiFrameworkVikeExtensionNames links/>, which means you control the React/Vue/Solid integration.

<Warning>
We recommend this only if you are an expert user and only if you have a strong & clear reason for not using <UiFrameworkVikeExtensionNames />.
</Warning>
