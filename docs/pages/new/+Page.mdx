...
> Make sure to install [Node.js](https://nodejs.org) which includes the `npm` package manager. (You can also use Bati and Vike with any other JavaScript package manager.)
