...
You can convert it to a [standard `Headers` object](https://developer.mozilla.org/en-US/docs/Web/API/Headers) using `new Headers()`:
...
You can add HTTP response headers by using `+headersResponse` and/or `pageContext.headersResponse`.
