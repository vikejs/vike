...
Example:
 - [/examples/react-full/](https://github.com/vikejs/vike/blob/6c6831865f00ff8d718bce7a1a083733a68faa65/examples/react-full/)
   - Toggle definition: [/renderer/+config.ts > `meta.dataIsomorph`](https://github.com/vikejs/vike/blob/6c6831865f00ff8d718bce7a1a083733a68faa65/examples/react-full/renderer/+config.ts#L14-L33)
