...
> **What is the Base URL?** Changing the Base URL (aka Public Path) is about changing the URL serving root.
...
<html>
  ...
  <body>
    ...
    <!-- Note how the Base URL is '/some-base/' -->
    <script src="/some-base/script.js" type="module" async></script>
  </body>
</html>
```
...
We can change the Base URL *only* of our assets by using the `baseAssets` configuration.

> The most common use case for this is when deploying assets to a CDN.
...
Note how the Base URL of our server isn't changed: our app is still served at `https://my-website.com/*`, i.e. the Base URL is still `/`.
...
<html>
  ...
  <body>
    ...
    <!-- Note how the Base URL is 'https://cdn.example.org/my-website-assets/' -->
    <script src="https://cdn.example.org/my-website-assets/script.js" type="module" async></script>
  </body>
</html>
```
