...
Get a free license valid for 3 months.
...
> Only enter **root** domains: a key is also valid for all subdomains — a key for `example.com` also covers `foo.example.com`, `bar.example.com`, etc.
