...
> `useData()` is implemented by the <UiFrameworkVikeExtension />. If you don't use <UiFrameworkVikeExtension name /> then see <Link href="/useData#without-vike-react-vue-solid" doNotInferSectionTitle />.
