...
> `useData()` is implemented by the <UiFrameworkExtension />. If you don't use <UiFrameworkExtension name /> then see <Link href="/useData#without-vike-react-vue-solid" doNotInferSectionTitle />.
