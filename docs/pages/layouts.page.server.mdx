...
> For a DX similar to Next.js's new Layout RFC, see [#346](https://github.com/brillout/vike/issues/346).
...
Until [#346](https://github.com/brillout/vike/issues/346) is implemented,
