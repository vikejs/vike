...
You can for example use <Link href="/extensions">`vike-react`</Link> to get a quick start like a regular frontend framework such as Next.js while later (progressively) replacing `vike-react` with a fully custom React integration.
