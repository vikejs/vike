...
> **What is SSR?** If you're unfamiliar with SSR then check out [Dan Abramov's excellent explanation of SSR and HTML Streaming](https://github.com/reactwg/react-18/discussions/37). (While it explains it in the context of React, we still recommend reading it if you use a UI framework other than React.)
