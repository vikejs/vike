...
> In case you don't use <UiFrameworkVikeExtension name />, you can implement `useData()` yourself as shown at <Link href="/useData#without-vike-react-vue-solid" doNotInferSectionTitle />
