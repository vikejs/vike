...
- <RepoLink href='/boilerplates/boilerplate-react/pages/star-wars/index/+data.js' />
- <RepoLink href='/boilerplates/boilerplate-react/pages/star-wars/index/+Page.jsx' /> (`useData()` usage)
- <RepoLink href='/boilerplates/boilerplate-react/pages/star-wars/@id/+data.js' />
- <RepoLink href='/boilerplates/boilerplate-react/pages/star-wars/@id/+Page.jsx' /> (`useData()` usage)

React + TypeScript:

- <RepoLink href='/boilerplates/boilerplate-react-ts/pages/star-wars/index/+data.ts' />
- <RepoLink href='/boilerplates/boilerplate-react-ts/pages/star-wars/index/+Page.tsx' /> (`useData()` usage)
- <RepoLink href='/boilerplates/boilerplate-react-ts/pages/star-wars/@id/+data.ts' />
- <RepoLink href='/boilerplates/boilerplate-react-ts/pages/star-wars/@id/+Page.tsx' /> (`useData()` usage)

Vue + JavaScript:

- <RepoLink href='/boilerplates/boilerplate-vue/pages/star-wars/index/+data.js' />
- <RepoLink href='/boilerplates/boilerplate-vue/pages/star-wars/index/+Page.vue' /> (`useData()` usage)
- <RepoLink href='/boilerplates/boilerplate-vue/pages/star-wars/@id/+data.js' />
- <RepoLink href='/boilerplates/boilerplate-vue/pages/star-wars/@id/+Page.vue' /> (`useData()` usage)

Vue + TypeScript:

- <RepoLink href='/boilerplates/boilerplate-vue-ts/pages/star-wars/index/+data.ts' />
- <RepoLink href='/boilerplates/boilerplate-vue-ts/pages/star-wars/index/+Page.vue' /> (`useData()` usage)
- <RepoLink href='/boilerplates/boilerplate-vue-ts/pages/star-wars/@id/+data.ts' />
- <RepoLink href='/boilerplates/boilerplate-vue-ts/pages/star-wars/@id/+Page.vue' /> (`useData()` usage)
