...
To set [`<head>` tags](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/head) such as [`<title>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/title) and [`<meta name="description">`](https://developers.google.com/search/docs/appearance/snippet#meta-descriptions) you can use:
...
Page specific `<head>` tags based on <Link href="/data-fetching">fetched data</Link>:
