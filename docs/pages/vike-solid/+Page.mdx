...
import { UseBati, UiFrameworkVikeExtensionNames } from '../../components'
...
> The guides, such as <Link href="/data-fetching" />, assume you're using Vike with <UiFrameworkVikeExtensionNames comma />. If you aren't then see the sections `Without vike-{react,vue,solid}` such as <Link href="/useData#without-vike-react-vue-solid" />.

You can also integrate Solid yourself instead of using `vike-solid`, see <Link href="/solid" />.
