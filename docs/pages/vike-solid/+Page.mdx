...
`vike-solid` is a <Link href="/extensions">Vike extension</Link> that integrates [Solid](https://solidjs.com) in a full-fledged manner, providing a DX like a regular frontend framework such as Solid Start.
