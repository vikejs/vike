...
> The guides, such as <Link href="/data-fetching" />, assume you're using Vike with <UiFrameworkVikeExtension name comma />. If you aren't then see the sections `Without vike-{react,vue,solid}` such as <Link href="/useData#without-vike-react-vue-solid" />.
