...
- Sets <Link href="/hooks">Vike hooks</Link> and <Link href="/settings">Vike settings</Link> on your behalf.
  ...
  >   (see [renderer/onRenderHtml.tsx](https://github.com/vikejs/vike-react/blob/main/packages/vike-react/src/integration/onRenderHtml.tsx))
  > - <Link href="/onRenderClient">`onRenderClient()`</Link>
  >   (see [renderer/onRenderClient.tsx](https://github.com/vikejs/vike-react/blob/main/packages/vike-react/src/integration/onRenderClient.tsx))
