...
`vike-react` is a <Link href="/extensions">Vike extension</Link> that integrates [React](https://react.dev) in a full-fledged manner, providing a DX like a regular frontend framework such as Next.js.
