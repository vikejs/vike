...
The `vike-react` package is a <Link href="/extensions">Vike extension</Link> that integrates [React](https://react.dev) in a full-fledged manner, providing a DX like a regular frontend framework like Next.js and Remix.
