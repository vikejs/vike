...
You can <Link href="/new">vike.dev/new</Link> for creating a new Vike + `vike-photon` app.
...
Photon includes a built-in server that supports basic features like SSR. If you need additional server functionality (e.g. [file uploads](https://hono.dev/examples/file-upload) or <Link href="/api-routes">API routes</Link>), create your own server as shown below.
