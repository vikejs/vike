...
In production, `vike-photon` uses [@universal-middleware/sirv](https://universal-middleware.dev/middlewares/sirv) to serve static files.
...
export default {
  ...
  photon: {// [!code ++]
    ...
    // @detype-uncomment static: { root: '/dist/client', maxAge: 3600 }// [!code ++]
  }// [!code ++]
} satisfies Config
```
