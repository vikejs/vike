...
import { PhotonDescription } from './PhotonDescription'
import PhotonBuiltInServer from './PhotonBuiltInServer.mdx'
import { PhotonBetaWarning } from './BetaWarning'
...
The `vike-photon` extension <PhotonDescription /> It's powered by [Photon](https://photonjs.dev).
