...
/renderer/PageWrapper.js  # The root (React/Vue/...) component that wraps the `Page` component
/renderer/PageWrapper.css # exported by `/pages/**/*.page.js`.
...
Examples:
- <RepoLink path='/examples/react/' />
- <RepoLink path='/examples/vue/' />
...
Example:
- <RepoLink path='/examples/file-structure-domain-driven/' />
