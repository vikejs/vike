...
Vike doesn't have built-in support for [API routes](https://nextjs.org/docs/api-routes/introduction) by design.

> We believe developing API tools independently from the frontend framework is a better appraoch.
