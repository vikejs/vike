...
You can also <Link href="#manual-integration">integrate React yourself</Link> if you want full control over the React integration.
...
Instead of using <Link href="/vike-react">`vike-react`</Link>, you can manually integrate React yourself, giving you full control over the integration of React and React libraries.
