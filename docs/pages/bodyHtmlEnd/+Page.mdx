import { Link, Warning, Tabs } from '@brillout/docpress'
...
<ConfigSpec
  ...
  cumulative
  global
  providedByExtension={{ kind: 'setting', name: 'bodyHtmlEnd', extension: ['vike-vue', 'vike-react'], noCustomGuide: true }}
/>
...
<Tabs choice={'uiFramework'} hiddenChoices={['Solid']} />
