...
<Figure width={400} text={<>This is the default loading animation. Its width is <code>100%</code> of the parent (here the parent's width is artificially set to <code>400px</code>). Its height is `width * 0.4`.</>}>
  <LoadingComponent />
</Figure>
