...
Inject the following to gather further information.
...
> This patch works with React `18.0.2` (and probably with most other React versions). Let us know if it doesn't work with your React version.

The debug logs will help you know why the React component is `undefined`. You'll likely discover that the React component is imported, while the import value is `undefined` because of some CJS/ESM interoperability quirks.
