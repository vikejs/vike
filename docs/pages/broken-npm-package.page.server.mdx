...
Another possible error message looks like:

<CodeBlockTransformer lineBreak="white-space">
```
TypeError: Cannot read properties of undefined (reading '__SOMETHING')
    at someFunction (node_modules/some-good-lib/src/index.js:137:19)
    at Object.h (node_modules/some-good-lib/src/index.js:320:16)
    at Object.call (node_modules/some-broken-lib/lib/something.js:26:30)
    at someHook (renderer/+someHook.jsx:12:29)
```
</CodeBlockTransformer>

The [solution](#solution) is to then add `some-broken-lib` to `vite.config.js > ssr.noExternal`.
