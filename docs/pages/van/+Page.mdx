...
Instead of using <Link href="/vike-vanjs">`vike-vanjs`</Link>, you can implement your own VanJS integration, for full control over the integration of VanJS and VanJS libraries.
