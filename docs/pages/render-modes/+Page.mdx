...
<Advanced>
  This page documents how to implement render modes yourself. It's an advanced task and we generally recommend simply using the <Link href="/ssr">`ssr` setting</Link> and <Link href="/pre-rendering#how-to-pre-render">`prerender` setting</Link> instead.
</Advanced>
