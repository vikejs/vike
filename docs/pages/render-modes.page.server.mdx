...
Example:
 ...
 - Vue Example: [GitHub > `AaronBeaudoin/vike-example` > `/pages/spa.page.client.vue`](https://github.com/AaronBeaudoin/vike-example/blob/main/pages/spa.page.client.vue)
...
Vue Example: [GitHub > `AaronBeaudoin/vike-example`](https://github.com/AaronBeaudoin/vike-example).
 - Server-side hook: [/pages/_default/_default.page.server.ts](https://github.com/AaronBeaudoin/vike-example/blob/main/pages/_default/_default.page.server.ts)
 - Client-side hook: [/pages/_default/_default.page.client.ts](https://github.com/AaronBeaudoin/vike-example/blob/main/pages/_default/_default.page.client.ts)
 - SPA page: [/pages/spa.page.client.vue](https://github.com/AaronBeaudoin/vike-example/blob/main/pages/spa.page.client.vue)
 - SSR page: [/pages/ssr.page.vue](https://github.com/AaronBeaudoin/vike-example/blob/main/pages/ssr.page.vue)
...
Examples:
 ...
 - Vue Example: [GitHub > `AaronBeaudoin/vike-example` > `/pages/html.page.server.vue`](https://github.com/AaronBeaudoin/vike-example/blob/main/pages/html.page.server.vue)
 - [@brillout/docpress](https://github.com/brillout/docpress) which powers this website `https://vike.dev` (this website uses the HTML-only technique).
