...
If you don't use <Link href="/vike-photon">`vike-photon`</Link>, you can define custom properties at <Link href="/renderPage">`renderPage()`</Link>.

> If you use `vike-photon`, use <Link href="/onCreatePageContext">`+onCreatePageContext`</Link> instead.
