...
> `pageContext.req` is an alias of <Link href="#runtime" noWarning>`pageContext.runtime.req`</Link>.
...
> `pageContext.res` is an alias of <Link href="#runtime" noWarning>`pageContext.runtime.res`</Link>.
