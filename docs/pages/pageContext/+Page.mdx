...
Alias for <Link href="#runtime">`pageContext.runtime.req`</Link> (the HTTP request object).
...
Alias for <Link href="#runtime">`pageContext.runtime.res`</Link> (the HTTP response object), see <Link href="#req">`pageContext.req`</Link>.
