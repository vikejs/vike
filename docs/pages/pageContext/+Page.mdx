...
> `pageContext.req` is a convenience alias of <Link href="#runtime" noWarning>`pageContext.runtime.req`</Link>. Vike doesn't override it if you define a <Link href="#custom">custom `pageContext.req` property</Link>.
...
> `pageContext.res` is a convenience alias of <Link href="#runtime" noWarning>`pageContext.runtime.res`</Link>, see <Link href="#req" noWarning>`pageContext.req`</Link>.
...
> To access the HTTP request and response objects, prefer the convenience aliases <Link href="#req" noWarning>`pageContext.req`</Link> and <Link href="#res" noWarning>`pageContext.res`</Link>.

```ts
// Environment: server

pageContext.runtime.req // Same as pageContext.req
pageContext.runtime.res // Same as pageContext.res
```
