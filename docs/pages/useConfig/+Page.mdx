...
```jsx
import { Config } from 'vike-react/Config' // or vike-solid
import { Head } from 'vike-react/Head' // or vike-solid
...
> It's currently only implemented by `vike-react` and `vike-solid`. Contribution welcome [for `vike-vue`](https://github.com/vikejs/vike-vue/issues/175).
