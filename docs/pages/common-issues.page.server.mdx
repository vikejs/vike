...
But some npm packages contain invalid Node.js code and we need to add them to [`vite.config.js > ssr.noExternal`](https://vitejs.dev/config/ssr-options.html#ssr-noexternal), see <Link href="/invalid-npm#solution" />.
