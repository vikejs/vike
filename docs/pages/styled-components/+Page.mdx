...
<CommunityNote tool="styled-components" url="https://styled-components.com" />

If you are using <Link href="/vike-react">vike-react</Link>, you can install [`vike-react-styled-components`](https://github.com/vikejs/vike-react/tree/main/packages/vike-react-styled-components#readme) for a seamless integration.
...
If you use <Link href="/vike-react">`vike-react`</Link>, you can manually integrate styled-components by using a combination of these:
