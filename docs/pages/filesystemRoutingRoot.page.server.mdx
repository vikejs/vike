...
The `filesystemRoutingRoot` setting allows you to change the URL of <Link href="/filesystem-routing">Filesystem Routing</Link>, which enables <Link href="/file-structure#domain-driven">domain-driven file structure</Link>.
