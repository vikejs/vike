...
Further examples can be found at [`precedence.spec.ts`](https://github.com/brillout/vite-plugin-ssr/blob/main/vite-plugin-ssr/shared/route/precedence.spec.ts).
