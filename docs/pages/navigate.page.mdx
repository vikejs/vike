...
Options:
 ...
 - `navigate('/some-url', { doNotCreateNewHistoryEntry: true })`: Do not create a new entry in the browser's history; the new URL will replace the current URL (this effectively removes the current URL from the history).
