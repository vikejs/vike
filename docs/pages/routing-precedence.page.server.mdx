...
> More examples at [`resolvePrecedence/route-strings.spec.ts`](https://github.com/brillout/vike/blob/main/vike/shared/route/resolvePrecedence/route-strings.spec.ts).
...
> More examples at [`resolvePrecedence/overall.spec.ts`](https://github.com/brillout/vike/blob/main/vike/shared/route/resolvePrecedence/overall.spec.ts).
