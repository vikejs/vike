...
<Warning>DON'T use this option without having contacted a `vite-plugin-ssr` maintainer: this functionality may be completely changed/removed at anytime if you don't.</Warning>
