...
>
> Path aliases must start with a special character so that Vike can distinguish between path alias imports and npm package imports. If it's an issue for you then elaborate your use case in a new <a href={projectInfo.githubDiscussions}>GitHub Discussion</a>.
