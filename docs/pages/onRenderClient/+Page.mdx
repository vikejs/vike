import { HookTypeScriptHints, UiFrameworkVikeExtension, UiFrameworkVikeExtension } from '../../components'
...
> If you use a <UiFrameworkVikeExtension/>, then you don't need to define `onRenderClient()` as it's already defined by <UiFrameworkVikeExtension name />.
