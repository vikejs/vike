...
> If you use a <VikeExtensionUiFramework/>, then you don't need to create the `title` and `description` settings as they are already created by <VikeExtensionUiFrameworkNames />. You can still read this section as it's a good example for showcasing `meta`.
...
> If you use a <VikeExtensionUiFramework/>, then you don't need to create the `Layout` setting as it's already created by <VikeExtensionUiFrameworkNames />.
