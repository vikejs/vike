...
<Warning>`meta` is meant for advanced usage: generally, we recommend using <Link href="/vike-packages">Vike packages</Link> instead.</Warning>

`meta` enables you to define:
 - **New settings**.
