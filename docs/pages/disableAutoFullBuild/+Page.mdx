...
> instead, we can set <Link text={<code>prerender.disableAutoRun</code>} href="/prerender#disableautorun" /> to `true` as it merely disables the automatic run of step `3`.
