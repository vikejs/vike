...
Vite-plugin-ssr doesn't implement [API routes](https://nextjs.org/docs/api-routes/introduction) by design. We believe decoupling the API is a more robust approach.
