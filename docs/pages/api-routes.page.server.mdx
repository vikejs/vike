import { Link, Note, Warning } from '@brillout/docpress'
...
- Directly use your server to create new HTTP endpoints (e.g. Express.js routes), giving you DX similar to API routes of frameworks like Next.js.
...
- GraphQL
  <Warning>
    If you aren't a *very* large team, then GraphQL is most likely over-engineering. Using RPC (Telefunc or tRPC) is simpler, and
