...
The `render()` hooks in `/renderer/_default.page.server.jsx` and `/renderer/_default.page.client.jsx` gives us full control over our pages are rendered.
...
There are four suffixes:
 ...
 - `.page.client.js`: exports page hooks (always run in the browser).
