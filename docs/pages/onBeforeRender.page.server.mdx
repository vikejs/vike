import { HookTypeScriptHints, VikeExtensionsUiFrameworksNames } from '../components'
...
> If you use a custom renderer instead of <VikeExtensionsUiFrameworksNames />, then you can modify your `onRenderHtml()`/`onRenderClient()` hooks instead of doing the following.
