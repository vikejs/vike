import { HookTypeScriptHints, VikeExtensionUiFrameworkNames } from '../components'
...
> If you use a custom renderer instead of <VikeExtensionUiFrameworkNames />, then you can modify your `onRenderHtml()`/`onRenderClient()` hooks instead of doing the following.
