...
If we use Client-side Routing and we redirect our user on the client-side only, then we may end up with a [hydration mismatch](/hydration#hydration-mismatch).
