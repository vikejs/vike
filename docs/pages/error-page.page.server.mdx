...
The error page is rendered when:
 ...
 3. One of your hooks used <Link href="/render" text={<code>throw render(abortStatusCode)</code>} />, for examle: `throw render(401, "You don't have the permission to access this page.")`.
