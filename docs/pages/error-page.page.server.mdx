...
> The error page is also rendered when vite-plugin-ssr throws an unexpected error (i.e. vite-plugin-ssr has a bug), but note that vite-plugin-ssr has no known bug and this is therefore very rare.
