...
- <a href={projectInfo.githubDiscussions}>GitHub Discussions</a> to get help from the Vike team.
  > If you follow [these rules](https://brillout.github.io/rules/) on GitHub Discussions then you'll always get a response from the Vike team.
- [GitHub Issues](https://github.com/vikejs/vike/issues) to report a bug or request a feature.

> Don't PM and don't ping the Vike team for getting help. Only PM us if you are a sponsor or for <Link href="#how-can-i-reach-out-for-business-inquiries" >business inquiries</Link>.
...
> Don't PM and don't ping the Vike team for getting help, see <Link href="#how-can-i-reach-out-for-help" doNotInferSectionTitle />
