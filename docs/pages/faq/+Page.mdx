...
Use <a href={projectInfo.discordInvite}>Discord</a> to get help from the community. (The Vike team is much less active on Discord, the community is most active on Discord.)
...
Use <a href={projectInfo.githubDiscussions}>GitHub Discussions</a> to get official help from the Vike team. (The Vike team is very active on GitHub, the community is less active on GitHub.)
