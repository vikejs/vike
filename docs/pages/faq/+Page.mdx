...
> In general, we care a lot about crafting helpful error messages. But we don't control error messages from other tools such as Node.js errors which are sometimes hard to understand.
