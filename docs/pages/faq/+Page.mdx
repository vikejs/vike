...
Use <a href={projectInfo.discordInvite}>Discord</a> to get help from the community. (The community is most active on Discord.)
...
Use <a href={projectInfo.githubDiscussions}>GitHub Discussions</a> to get official help from the Vike team. (The Vike team is most active on GitHub.)
