...
Instead of using <Link href="/vike-solid">`vike-solid`</Link>, you can implement your own Solid integration for full control over Solid as well as Solid libraries.
