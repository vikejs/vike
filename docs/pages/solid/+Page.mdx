...
Instead of using <Link href="/vike-solid">`vike-solid`</Link>, you can implement your own Solid integration for full control over Solid itself as well as Solid libraries.

<CustomIntegrationWarning uiFramework="solid" />

Official example:
 - [`vike-solid` source code](https://github.com/vikejs/vike-solid/tree/main/vike-solid) - Full-fledged integration.
