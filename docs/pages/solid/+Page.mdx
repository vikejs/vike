...
You can also <Link href="#manual-integration">integrate Solid yourself</Link> if you want full control over the Solid integration.


## Manual integration

Instead of using <Link href="/vike-solid">`vike-solid`</Link>, you can manually integrate Solid yourself, giving you full control over the integration of Solid and Solid libraries.
