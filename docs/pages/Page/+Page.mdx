...
> Instead of <UiFrameworkVikeExtensionNames />, you can manually integrate the <Link href="/ui-framework">UI framework</Link> yourself, see <Link href="#without-vike-react-vue-solid" />.
