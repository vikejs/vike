...
What happens with the `Page` value is determined by the <UiFrameworkVikeExtension />. Alternatively, for complete control over the <Link href="/ui-framework">UI framework</Link> integration, you can <Link href="#without-vike-extension">manually integrate</Link> the UI framework yourself.
