...
> Instead of using <UiFrameworkExtension name />, you can also manually integrate the <Link href="/ui-framework">UI framework</Link> yourself, see <Link href="#without-vike-react-vue-solid" />.
...
Instead of using <UiFrameworkExtension name />, you can integrate your favorite UI framework yourself: you then have complete control over the UI framework integration.
