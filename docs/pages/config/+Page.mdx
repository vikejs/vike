...
> <Link href="#cumulative">Cumulative configurations</Link> don't get overriden.
...
> See also: [#1692 - New settings `inherit` and `default` for controlling inheritance of cumulative configs](https://github.com/vikejs/vike/issues/1692)
