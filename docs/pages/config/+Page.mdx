...
> <Link href="#cumulative">Cumulative configs</Link> don't get overriden but accumulate instead (unless the filename extension <Link href="#default-js" doNotInferSectionTitle /> is used).
