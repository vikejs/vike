...
The `renderPage()` function enables you to integrate vite-plugin-ssr into any server:
...
If you use server-side rendering (SSR), then you need to use `renderPage()` in order to manually integrate vite-plugin-ssr into your server yourself.
