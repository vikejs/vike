...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>`<title>` <br /> `<meta property="og:title">`</td>
    </tr>
    <tr>
      <td><Link href="/description">`+description`</Link></td>
      <td>`<meta name="description">` <br /> `<meta property="og:description">`</td>
    </tr>
    <tr>
      <td><Link href="/image">`+image`</Link></td>
      <td>`<meta property="og:image">` (preview image upon URL sharing) <br /> `<meta name="twitter:card" content="summary_large_image">`</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        Other `<head>` tags such as: <br />
        `<link rel="icon">` (favicon) <br />
        `<link rel="apple-touch-icon">` (mobile icon) <br />
        `<script>` <br />
        ...
      </td>
    </tr>
