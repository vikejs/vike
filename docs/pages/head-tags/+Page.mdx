...
| Setting                                         | HTML
|------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <Link href="/title">`+title`</Link>             | `<title>` <br /> `<meta property="og:title">`                                      |
| <Link href="/description">`+description`</Link> | `<meta name="description">` <br /> `<meta property="og:description">`                          |
| <Link href="/image">`+image`</Link>             | `<meta property="og:image">` (preview image upon URL sharing) <br /> `<meta name="twitter:card" content="summary_large_image">` |
| <Link href="/viewport">`+viewport`</Link>       | `<meta name="viewport">`                                                                                              |
| <Link href="/Head">`+Head`</Link>               | Other `<head>` tags such as: <br /> `<link rel="icon">` (favicon) <br /> `<link rel="apple-touch-icon">` (mobile icon) <br /> `<script>` <br /> ... |
</TableStyle>
