...
Similarly to the previous section, when using <Link text="Nested Layouts" href="/Layout#nested-layouts" />, the state of the outer page is preserved, which means Nested Layouts cannot be implemented using Server Routing.
