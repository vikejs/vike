...
import { ServerRouting, ClientRouting, DefaultRouting, VikeExtensionUiFramework } from '../components'
...
If you don't use a <VikeExtensionUiFramework />, then we recommend to use Server Routing by default as it leads to a significantly simpler architecture.
