...
If you don't use a Vike extension <Link href="/extensions#ui-frameworks"><code>vike-react</code>, <code>vike-vue</code>, or <code>vike-solid</code></Link>, then we recommend to use Server Routing by default as it leads to a significantly simpler architecture.
