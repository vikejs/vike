...
import { ServerRouting, ClientRouting, DefaultRouting, VikeExtensionsUiFrameworks } from '../components'
...
If you don't use a <VikeExtensionsUiFrameworks />, then we recommend to use Server Routing by default as it leads to a significantly simpler architecture.
