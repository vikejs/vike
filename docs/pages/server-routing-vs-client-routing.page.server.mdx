...
import { DefaultRouting, UiFrameworkVikeExtension } from '../components'
...
If you don't use a <UiFrameworkVikeExtension />, then we recommend to use Server Routing by default as it leads to a simpler architecture.
