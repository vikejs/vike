...
- Skips [built-in ignore patterns](https://github.com/vikejs/vike/blob/main/vike/node/plugin/plugins/importUserCode/v1-design/getVikeConfig/crawlPlusFiles/ignorePatternsBuiltIn.ts) such as `node_modules/` and `ejected/`.
