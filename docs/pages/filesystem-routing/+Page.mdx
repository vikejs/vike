...
- Skips [built-in ignore patterns](https://github.com/vikejs/vike/blob/main/packages/vike/src/node/vite/shared/resolveVikeConfigInternal/crawlPlusFilePaths/ignorePatternsBuiltIn.ts) such as `node_modules/` and `ejected/`.
