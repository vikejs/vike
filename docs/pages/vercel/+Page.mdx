...
You can deploy Vike to [Vercel](https://vercel.com) simply by using a Vercel API Route. Alternatively, you can use `vite-plugin-vercel` for a fully-fledged Vercel integration with ISR and Edge Middlewares.
