...
We recommend <Link href="#photon">using Photon</Link> for a seamless and full-fledged [Vercel](https://vercel.com) integration, including [Incremental Static Regeneration (ISR)](https://vercel.com/docs/concepts/incremental-static-regeneration/overview).


> <UseScaffolder>Vercel (using Photon)</UseScaffolder>
...
<Link href="/vike-photon" /> enables zero-configuration support for all Vercel features, including [Incremental Static Regeneration (ISR)](https://vercel.com/docs/concepts/incremental-static-regeneration/overview).
...
Vike supports [Incremental Static Regeneration (ISR)](https://vercel.com/docs/concepts/incremental-static-regeneration/overview) when <Link href="#photon">using Photon</Link>.
