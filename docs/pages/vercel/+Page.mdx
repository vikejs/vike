...
We recommend <Link href="#photon">using Photon</Link> for a seamless and full-fledged [Vercel](https://vercel.com) integration with ISR and Edge Middlewares.
...
TODO: add steps like /cloudflare instead of just linking to /vike-photon
