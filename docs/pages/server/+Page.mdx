...
import { CodeVariantsServer, CodeVariant } from '../../components'
...
<CodeVariantsServer filePath={"server/index"}>
  <CodeVariant framework={"Express.js"}>
    ```js
