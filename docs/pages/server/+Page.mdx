...
To integrate Vike with a JavaScript server, we recommend the `vike-server` extension — it supports popular servers (Hono, Express, ...) and deployments (Cloudflare, Vercel, ...).
