...
- <Link href="/cloudflare">Vike Docs > Deploy > Cloudflare</Link>

It also documents how to deploy fully static websites (aka <Link href="/pre-rendering#ssg">SSG / pre-rendered apps</Link>) with Cloudflare.
</Warning>
