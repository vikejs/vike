...
The [vike-cloudflare](https://github.com/vikejs/vike-cloudflare) package enables zero-configuration deployment to <a href="https://pages.cloudflare.com/">Cloudflare Pages</a>.
It will deploy prerendered routes as static files, and dynamic routes as <a href="https://developers.cloudflare.com/pages/functions/advanced-mode/">Pages Functions</a>.
