...
```js
// /renderer/_default.page.js
// We let `vite-plugin-ssr` know about our isomorphic custom exports.
export const customExports = ['PageLayout']
```
...
export { render }
// We let `vite-plugin-ssr` know about our server-side custom exports.
export const customExports = ['getDocumentTitle', 'query']
