...
> This scaffolds a Vike app that uses <UiFrameworkExtension name links /> which are the official React, Vue, and Solid integrations maintained by the Vike team.
>
> While we recommend using <UiFrameworkExtension name /> you can also <Link href="/new#without-vike-react-vue-solid">manually integrate React/Vue/Solid yourself</Link>.
