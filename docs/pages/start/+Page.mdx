...
> This scaffolds a Vike app that uses <UiFrameworkExtension name noLink links /> which are the official React, Vue, and Solid integrations maintained by the Vike team.
>
