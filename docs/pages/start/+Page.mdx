...
> This scaffolds a Vike app that uses <UiFrameworkVikeExtensionNames links /> which are the official React, Vue, and Solid integrations maintained by the Vike team.
>
> While we recommend using <UiFrameworkVikeExtensionNames /> you can also <Link href="/new#without-vike-react-vue-solid">manually integrate React/Vue/Solid yourself</Link>.
