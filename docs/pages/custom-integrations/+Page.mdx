...
In general, we recommend using Vike extensions whenever possible, and falling back to a custom integration only if you have a strong and clear reason to do so.
