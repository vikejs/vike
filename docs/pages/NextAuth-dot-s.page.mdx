...
In order to use NextAuth.js's [`getSession()`](https://next-auth.js.org/getting-started/client#getsession) on the server-side, you'll need to install a fetch polyfill globally.
