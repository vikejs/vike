...
In practice, this means that we can use VPS with whatever tool we want and, in fact, users are using VPS with all kinds of tools within all kinds of environments.
