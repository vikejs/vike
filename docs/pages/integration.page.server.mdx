...
> If you struggle integrating a tool, don't hesitate to [create a new GitHub Discussion](https://github.com/brillout/vike/discussions/new).
...
Official examples: [GitHub > `brillout/vike` > `examples/`](https://github.com/brillout/vike/tree/main/examples).
