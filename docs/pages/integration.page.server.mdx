...
From the perspective of our server architecture, `vite-plugin-ssr` is just a server middleware.
...
app.get('*', async (req, res) => {
  ...
  // environments such as AWS Lambda, Cloudflare Workers, and Vercel.
