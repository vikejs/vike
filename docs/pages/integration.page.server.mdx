...
In practice, this means that we can use VPS with whatever tool we want and. In fact, VPS is being used with all kinds of tools within all kinds of environments.
