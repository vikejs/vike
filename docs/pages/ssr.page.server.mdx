...
Setting to enable/disable Server-Side Rendering (SSR). You can disable SSR for all your pages, or only for some pages while still using SSR for your other pages.
