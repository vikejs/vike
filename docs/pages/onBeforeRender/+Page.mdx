...
> If you use a custom renderer instead of <UiFrameworkExtension name />, then you can modify your `onRenderHtml()`/`onRenderClient()` hooks instead of doing the following.
