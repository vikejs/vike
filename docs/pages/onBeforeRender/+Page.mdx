...
> If you use a custom renderer instead of <UiFrameworkVikeExtension name />, then you can modify your `onRenderHtml()`/`onRenderClient()` hooks instead of doing the following.
