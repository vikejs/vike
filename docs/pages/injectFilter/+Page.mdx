...
> Vite also injects preload tags, see [Vite Docs > Config > `build.modulePreload`](https://vitejs.dev/config/build-options#build-modulepreload).
...
- [Vite Docs > Config > `build.modulePreload`](https://vitejs.dev/config/build-options#build-modulepreload)
