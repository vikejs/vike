...
The `injectFilter()` hook allows you to control where and what preload and asset tags Vike injects in the HTML.

> If you merely want to change the position of scripts, then you can use the <Link href="/injectScriptsAt">`injectScriptsAt` setting</Link> instead.

See <Link href="/preloading" />.
