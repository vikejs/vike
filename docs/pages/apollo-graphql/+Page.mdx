...
<CommunityNote url="https://www.apollographql.com" />

If you are using <Link href="/vike-react">vike-react</Link>, you can install [`vike-react-apollo`](https://github.com/vikejs/vike-react/tree/main/packages/vike-react-apollo) for a seamless integration.
