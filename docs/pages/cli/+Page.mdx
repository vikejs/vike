...
> These are all Vike settings — Vike aliases some Vite settings for convenience (see <Link href="/host" noBreadcrumb />/<Link href="/port" noBreadcrumb />/<Link href="/mode" noBreadcrumb />/<Link href="/prerender" noBreadcrumb />).
...
> Technically these are Vike settings that alias Vite settings (see <Link href="/host" noBreadcrumb />/<Link href="/port" noBreadcrumb />/<Link href="/mode" noBreadcrumb />). In other words, Vike's CLI options are always <Link href="/settings">Vike settings</Link>.
>
