...
> Each of these is a Vike setting that aliases a Vite setting (see <Link href="/host" noBreadcrumb />/<Link href="/mode" noBreadcrumb />/<Link href="/port" noBreadcrumb />/<Link href="/force" noBreadcrumb />/<Link href="/root" noBreadcrumb />). Each Vike CLI option sets a <Link href="/settings">Vike setting</Link>.
>
