...
> These are actually Vike settings, which alias Vite settings. (See <Link href="/host" noBreadcrumb />/<Link href="/mode" noBreadcrumb />/<Link href="/port" noBreadcrumb />/<Link href="/force" noBreadcrumb />.) In other words: each Vike CLI option corresponds to a <Link href="/settings">Vike setting</Link>.
>
