...
> These are actually Vike settings that alias Vite settings. (See <Link href="/host" noBreadcrumb />/<Link href="/mode" noBreadcrumb />/<Link href="/port" noBreadcrumb />/<Link href="/force" noBreadcrumb />.) In other words: Vike's CLI options are always <Link href="/settings">Vike settings</Link>.
>
