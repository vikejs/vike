...
> These are Vike settings, see <Link href="/host" noBreadcrumb />/<Link href="/port" noBreadcrumb />/<Link href="/mode" noBreadcrumb />/<Link href="/prerender" noBreadcrumb />/<Link href="/force" noBreadcrumb />/<Link href="/root" noBreadcrumb />. Note that Vike aliases some Vite settings for convenience, see <Link href="#vite-settings"/>.
