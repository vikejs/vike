...
Some [npm packages](https://www.npmjs.com) contain invalid JavaScript code that lead to errors (see <Link href="#common-errors" />).
...
> See <Link href="#why" /> for explanation why `ssr.noExternal` is a workaround.
...
> If none of these workarounds work, then don't hesitate to <Link href="/faq#can-i-reach-out-for-help">reach out for help</Link>.
...
Error: Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: undefined. You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.
    at renderElement (node_modules/react-dom/cjs/react-dom-server-legacy.node.development.js:6047:9)
    ...
    at node_modules/react-dom/cjs/react-dom-server-legacy.node.development.js:6904:12
...
If the component lives inside `node_modules/`, then consider <Link href="#workaround">adding the npm package(s) to `ssr.noExternal`</Link>.
