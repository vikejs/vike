...
>
> The situation is going to improve, and eventually be completely resolved, as Vite-based frameworks gain popularity which is happening quickly: all frameworks other than Next.js are now Vite-based.
