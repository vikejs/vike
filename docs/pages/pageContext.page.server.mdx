...
The `pageContext` is at the core of `vite-plugin-ssr`: it holds all the information about the page currently being rendered.
...
import type { PageContextBuiltInClient } from 'vite-plugin-ssr'
