...
import { Github, UseBatiHint_insteadOfManuelIntegration } from '../components'
...
<UseBatiHint_insteadOfManuelIntegration toolName="Vercel" />
...
Example: <Github>brillout/vike-with-vercel</Github>.
...
If you <Link text="pre-render your pages only partially" href="/prerender-config#partial" />, you can also use `vite-plugin-vercel` to statically deploy your pre-rendered pages while dynamically serving your non-prerendered pages.
