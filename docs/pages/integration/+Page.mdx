...
<Advanced>
The following documents how to manually integrate tools for fetching initial data. We recommend using a Vike extension that already does this for you instead.
</Advanced>
