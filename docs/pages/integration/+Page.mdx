...
Some data-fetching tools enable you to fetch a page's initial data on a component-level instead of <Link href="/data-fetching#data">using the page-level Vike hook `data()`</Link>
