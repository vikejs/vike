...
> We recommend using the [GitHub Pages Deploy Action](https://github.com/JamesIves/github-pages-deploy-action). For example, `vike.dev` uses [this GitHub workflow](https://github.com/vikejs/vike/blob/main/.github/workflows/website-deploy.yml) to automatically deploy whenever a commit changes Vike's docs.
