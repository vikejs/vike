...
We recommend using the [GitHub Pages Deploy Action](https://github.com/JamesIves/github-pages-deploy-action). For example, `vite-plugin-ssr.com` uses the GitHub action at <RepoLink path='.github/workflows/docs.yml' /> to automatically deploy whenever a commit changes the docs.
