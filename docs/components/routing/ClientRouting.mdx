...
By default, Vike does Server Routing. We can opt into Client Routing by setting the <Link text={<><code>clientRouting</code> setting</>} href="/clientRouting" /> to `true`.
