...
- Skips [built-in ignore patterns](https://github.com/vikejs/vike/blob/main/vike/node/vite/shared/resolveVikeConfigInternal/crawlPlusFiles/ignorePatternsBuiltIn.ts) such as `node_modules/` and `ejected/`.
