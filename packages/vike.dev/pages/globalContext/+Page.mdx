...
When a user starts visiting your website, a new `globalContext` object is created that lives until the user closes your website. If the user opens your website in multiple tabs, there is one `globalContext` per tab.
