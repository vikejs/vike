...
>
> It only provides configurations at build-time. To get configurations at runtime use <Link href="/globalContext#config">`globalContext.config`</Link> and <Link href="/globalContext#pages">`globalContext.pages`</Link> instead.
