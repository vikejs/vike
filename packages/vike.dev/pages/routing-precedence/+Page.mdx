...
> You can find more examples at [`resolvePrecedence_route-strings.spec.ts`](https://github.com/vikejs/vike/blob/main/vike/shared/route/resolvePrecedence/resolvePrecedence_route-strings.spec.ts).
