...
<QuoteTeam style={{marginTop: 60, marginBottom: 45}}>Paying for Open Source isn't a bug — it's a feature: it ensures Vike's interests are aligned with yours, while keeping Vike available to everyone.</QuoteTeam>
...
The implementation is 100% offline: it uses asymmetric encryption to validate license keys, and reads your Git history to distinguish small apps from larger apps. It doesn't send any telemetry nor makes any server requests.
