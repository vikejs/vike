...
> The Vike packages/create-vike-core do SSR by default, which is a sensible default that works for most apps.
...
The Vike packages/create-vike-core and documentation use SSR by default.

So, if we only have SSR pages, then there is nothing for us to do: we simply follow the packages/create-vike-core/docs.
