...
function resolveImportPathWithNode(
  ...
  if (!filePathAbsoluteFilesystem && isImportPathRelative(pointerImportData.importPath)) {
    ...
    */
    ...
    assertUsage(
      false,
      `${errIntro} couldn't be resolved: does ${importPathString} point to an existing file?`,
    )
  }
