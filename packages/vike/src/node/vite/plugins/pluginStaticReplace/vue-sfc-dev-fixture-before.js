...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(
    `<!--[--><h1 data-v-c63e5769>ClientOnly</h1><h2 data-v-c63e5769>Using <code data-v-c63e5769>&lt;ClientOnly&gt;</code> component</h2><h3 data-v-c63e5769>Basic example with fallback</h3>`,
  )
  _push(
    _ssrRenderComponent(
      $setup['ClientOnly'],
      null,
      {
        fallback: _withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [_createVNode('p', null, 'Loading client-only component...')]
          }
        }),
      ...
      null,
      {
        default: _withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [_createVNode($setup['ClientOnlyComponent'], { msg: 'bonjour' })]
          }
        }),
        _: 1,
      },
