...
function createHttpResponseCommon(
  ...
  if (htmlRender === null) {
    // @brillout TODO/after-merge: dedupe such HTML responses generated by Vike
    htmlRender = `<p style="display: none">No response.</p><script>console.log('This HTML was generated by Vike.')</script>`
  }
