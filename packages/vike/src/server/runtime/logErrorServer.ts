...
import type { PageContextCreatedServer, PageContextCreatedWithoutGlobalContext } from './renderPageServer/createPageContextServer.js'
assertIsNotBrowser()
const globalObject = getGlobalObject('server/runtime/logErrorServer.ts', {
  wasAlreadyLogged: new WeakSet<object>(),
})

function logErrorServer(err: unknown, pageContext: null | PageContextCreatedServer | PageContextCreatedWithoutGlobalContext) {
