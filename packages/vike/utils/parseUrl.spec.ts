    ...
    expect(parseUrl('/shop?fruits=apples&candies=chocolate,lollipop', '/')).toMatchInlineSnapshot(`
      {
        ...
        "isBaseMissing": false,
        "origin": null,
        "path": "/shop?fruits=apples&candies=chocolate,lollipop",
        "pathname": "/shop",
    ...
    expect(parseUrl(`/shop${searchQuery}`, '/shop')).toMatchInlineSnapshot(`
      {
        ...
        "isBaseMissing": false,
        "origin": null,
        "path": "/?fruit=apples&fruit=bananas&candy=chocolate&candy=lollipop&constructor=val1&constructor=val2",
        "pathname": "/",
        "pathnameOriginal": "/shop",
        "port": null,
        "protocol": null,
  ...
  it('doc example', () => {
    expect(
    ...
    ).toMatchInlineSnapshot(`
      {
        ...
        "path": "/hello/sébastien?fruit=%C3%A2pple&fruit=orânge#%C3%A2ge",
    ...
    expect(parseUrl('capacitor://localhost/assets/chunks/chunk-v3mOCch-.js', '/')).toMatchInlineSnapshot(`
      {
        ...
        "path": "/assets/chunks/chunk-v3mOCch-.js",
