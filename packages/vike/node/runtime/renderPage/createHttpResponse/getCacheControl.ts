...
export { cacheControlDisableCache }

import type { PageConfigRuntime } from '../../../../types/PageConfig.js'
import { getPageConfig } from '../../../../shared/page-configs/helpers.js'
import { getConfigValueRuntime } from '../../../../shared/page-configs/getConfigValueRuntime.js'

const cacheControlDisableCache = 'no-store, max-age=0'
...
function getCacheControl(pageId: string | null, pageConfigs: PageConfigRuntime[]): string {
  ...
  if (pageConfigs.length === 0) return cacheControlDisableCache
  ...
  return cacheControlDisableCache
}
