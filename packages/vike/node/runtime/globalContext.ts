...
import type { VikeConfigPublic } from '../../shared/page-configs/resolveGlobalConfigPublic.js'
...
function resolveBaseRuntime(viteConfigRuntime: BuildInfo['viteConfigRuntime'], config: VikeConfigPublic['config']) {
