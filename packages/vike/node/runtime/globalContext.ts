...
//   - loadProdBuildEntry() sets globalObject.buildEntry and then sets virtualFileExportsGlobalEntry
...
function assertProdBuildEntry(buildEntry: unknown): asserts buildEntry is ProdBuildEntry {
