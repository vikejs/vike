...
import { logInfoNotProd, clearWithVite } from '../../shared/loggerNotProd'
...
function importUserCode(): Plugin {
  ...
  return {
    ...
    handleHotUpdate(ctx) {
      ...
      logInfoNotProd(`Config file change: ${pc.dim(makeRelativeToUserRootDir(file, config.root))}`, 'config', 'info')
