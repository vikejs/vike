...
import { getHtmlString } from '../html/renderHtml.mjs'
import { type PageFile, getPageFilesAll } from '../../../shared/getPageFiles.mjs'
import { assert, assertUsage, hasProp, objectAssign, unique } from '../utils.mjs'
import { serializePageContextClientSide } from '../html/serializePageContextClientSide.mjs'
import { addUrlComputedProps, type PageContextUrlComputedProps } from '../../../shared/UrlComputedProps.mjs'
import { getGlobalContext } from '../globalContext.mjs'
import { createHttpResponseObject, createHttpResponsePageContextJson, HttpResponse } from './createHttpResponseObject.mjs'
import { loadPageFilesServerSide, PageContext_loadPageFilesServerSide, type PageFiles } from './loadPageFilesServerSide.mjs'
import type { PageConfig, PageConfigGlobal } from '../../../shared/page-configs/PageConfig.mjs'
import { executeOnRenderHtmlHook } from './executeOnRenderHtmlHook.mjs'
import { executeOnBeforeRenderHooks } from './executeOnBeforeRenderHook.mjs'
import { logRuntimeError } from './loggerRuntime.mjs'
import { isNewError } from './isNewError.mjs'
import { preparePageContextForUserConsumptionServerSide } from './preparePageContextForUserConsumptionServerSide.mjs'
import { executeGuardHook } from '../../../shared/route/executeGuardHook.mjs'
import { loadPageRoutes, type PageRoutes } from '../../../shared/route/loadPageRoutes.mjs'
import type { OnBeforeRouteHook } from '../../../shared/route/executeOnBeforeRouteHook.mjs'
