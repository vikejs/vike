import{j as e,i as a,L as c,o as i}from"../chunks/chunk-CQb_Cmff.js";import{L as n}from"../chunks/chunk-BFIoV77j.js";/* empty css                      */import{W as o}from"../chunks/chunk-DVhi-VJ2.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-Di87wguG.js";import{P as t}from"../chunks/chunk-2ZIo8p0I.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-Day44_Qu.js";/* empty css                      */const d=[{pageSectionId:"using-data",pageSectionLevel:2,pageSectionTitle:"Using data"},{pageSectionId:"head-inside-components",pageSectionLevel:3,pageSectionTitle:"`<Head>` inside components"},{pageSectionId:"useconfig-inside-data",pageSectionLevel:3,pageSectionTitle:"`useConfig()` inside `+data`"},{pageSectionId:"usedata-usepagecontext-inside-head",pageSectionLevel:3,pageSectionTitle:"`useData()`/`usePageContext()` inside `+Head`"},{pageSectionId:"only-html",pageSectionLevel:2,pageSectionTitle:"Only HTML"},{pageSectionId:"cumulative",pageSectionLevel:2,pageSectionTitle:"Cumulative"},{pageSectionId:"how-to-inject-raw-html",pageSectionLevel:2,pageSectionTitle:"How to inject raw HTML?"},{pageSectionId:"react",pageSectionLevel:3,pageSectionTitle:"React"},{pageSectionId:"vue",pageSectionLevel:3,pageSectionTitle:"Vue"},{pageSectionId:"solid",pageSectionLevel:3,pageSectionTitle:"Solid"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Kind: cumulative.",e.jsx(s.br,{}),`
`,"Environment: server."]}),`
...
`]}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"jsx","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"jsx","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /pages/+Head.{jsx,vue}"})}),`
...
`,e.jsxs(s.li,{children:["intended for ",e.jsx(s.strong,{children:"crawlers"})," (e.g. SEO or social sharing tags), or"]}),`
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"static"})," (e.g. favicon or PWA settings that don't change between pages)."]}),`
`]}),`
`,e.jsxs(s.p,{children:["You cannot use it for dynamic tags intended for the user's browser such as ",e.jsx(s.code,{children:"<title>"})," (use ",e.jsx(n,{href:"/title",children:e.jsx(s.code,{children:"+title"})})," instead)."]}),`
`]}),`
...
`,e.jsx(s.p,{children:e.jsx(s.strong,{children:"Only rendered for the first page's HTML"})}),`
