...
`,e.jsxs(n.p,{children:["These are all Vike settings — Vike aliases some Vite settings for convenience (see ",e.jsx(s,{href:"/host",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/port",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/mode",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/prerender",noBreadcrumb:!0}),")."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Technically these are Vike settings that alias Vite settings (see ",e.jsx(s,{href:"/host",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/port",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/mode",noBreadcrumb:!0}),"). In other words, Vike's CLI options are always ",e.jsx(s,{href:"/settings",children:"Vike settings"}),"."]}),`
