import{o as T,a as C}from"../chunks/chunk-D_TDA_Ef.js";import{j as e,r as c}from"../chunks/chunk-uzzTZiGr.js";import{L as d}from"../chunks/chunk-D8zqnqQy.js";import{D as E}from"../chunks/chunk-Cvgz3wI3.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{a as S}from"../chunks/chunk-BKCdOfRb.js";import{T as z,a as D,b as g,c as b}from"../chunks/chunk-qWZfM6pI.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */function R(t){const n=[{text:"export default {",license:!1},{text:"  license: {",license:!0}];for(const[s,i]of Object.entries(t)){const r=typeof i=="string"?`    '${s}': '${i}',`:`    '${s}': { expires: '${i.expires}', key: '${i.key}' },`;n.push({text:r,license:!0})}return n.push({text:"  },",license:!0},{text:"}",license:!1}),n}function L(t){const n=[];return t.split(/('[^']*')/g).forEach((s,i)=>{if(i%2===1){n.push(e.jsx("span",{className:"tok-str",children:s},i));return}s.split(/\b(export|default)\b/g).forEach((r,o)=>{r&&(o%2===1?n.push(e.jsx("span",{className:"tok-kw",children:r},`${i}-${o}`)):n.push(r))})}),n}function U({license:t}){const[n,s]=c.useState(!1),i=[{text:"// pages/+config.js",license:!1},{text:"",license:!1},...R(t)];async function r(){try{await navigator.clipboard.writeText(i.filter(o=>o.license).map(o=>o.text).join(`
