import{o,a as i}from"../chunks/chunk-C8N046DI.js";import{j as e,b as c}from"../chunks/chunk-Ch0sRy5R.js";import{L as n}from"../chunks/chunk-cySdRfqv.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as t}from"../chunks/chunk-CRr9echR.js";/* empty css                      *//* empty css                      */const d=[{pageSectionId:"pagecontext-user",pageSectionLevel:2,pageSectionTitle:"`pageContext.user`"},{pageSectionId:"ssg",pageSectionLevel:2,pageSectionTitle:"SSG"},{pageSectionId:"login-flow",pageSectionLevel:2,pageSectionTitle:"Login flow"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...t(),...l.components},{CodeSnippets:r}=s;return r||p("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"In principle, you can use Vike with any authentication tool such as:"}),`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["If you use ",e.jsx(n,{href:"/vike-photon",children:e.jsx(s.code,{children:"vike-photon"})}),", you can access the request object at ",e.jsx(s.code,{children:"pageContext.runtime.req.user"})," (see ",e.jsx(n,{href:"/pageContext#runtime",children:e.jsx(s.code,{children:"pageContext.runtime"})}),")."]}),`
...
`]}),`
`,e.jsxs(s.p,{children:["See ",e.jsx(c,{text:"example",path:"/examples/auth/"}),"."]}),`
`]}),`
