import{o as r,a as t}from"../chunks/chunk-DRGPPRF9.js";import{j as e}from"../chunks/chunk-Bym4unht.js";import{L as n}from"../chunks/chunk-bTfkTGJz.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as o}from"../chunks/chunk-H-nyntWo.js";/* empty css                      *//* empty css                      *//* empty css                      */const d=[{pageSectionId:"vite-config-js",pageSectionLevel:2,pageSectionTitle:"`vite.config.js`"},{pageSectionId:"tsconfig-json",pageSectionLevel:2,pageSectionTitle:"`tsconfig.json`"},{pageSectionId:"package-json",pageSectionLevel:2,pageSectionTitle:"`package.json`"},{pageSectionId:"config-files",pageSectionLevel:2,pageSectionTitle:"Config files"}];function a(i){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...o(),...i.components},{ChoiceGroup:l}=s;return l||h("ChoiceGroup"),e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"Instead of using relative import paths, which can be cumbersome, you can use path aliases. For example:"}),`
