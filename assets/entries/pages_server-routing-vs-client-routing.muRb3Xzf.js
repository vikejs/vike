...
`,e.jsxs(t.p,{children:["Similarly to the previous section, when using ",e.jsx(n,{href:"/Layout#nested",children:"Nested Layouts"}),", the state of the outer page is preserved, which means Nested Layouts cannot be implemented using Server Routing."]}),`
`,e.jsx(t.p,{children:e.jsx(t.em,{children:"Requirement: Client-side Routing."})}),`
