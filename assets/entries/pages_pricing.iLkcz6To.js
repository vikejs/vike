import{j as e,a as t,i as S,L as T,o as F}from"../chunks/chunk-D3NY1Dio.js";import{L as r}from"../chunks/chunk-BxIOGfCD.js";/* empty css                      */import{a as P}from"../chunks/chunk-qM-Toi2n.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-CPa_GF1m.js";import{O}from"../chunks/chunk-7j5OQDDi.js";/* empty css                      *//* empty css                      *//* empty css                      */import{Q as V}from"../chunks/chunk-CBRjBUn1.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-D2sU9sXp.js";const b="#a00",w="#0a0",C="#e90";function h(){return e.jsx(e.Fragment,{children:" |"})}function z(){return e.jsx("span",{style:{color:w,fontSize:"1.9em",display:"block"},children:"✓"})}function I(){return e.jsx("span",{style:{color:b,fontSize:"1.6em",display:"block"},children:"✗"})}function L({value:s}){const u=m(),o=N(s);return e.jsx("div",{className:"value-gauge",style:{height:9,borderWidth:1,borderStyle:"solid",borderColor:"#ddd",borderRadius:10,display:"flex",padding:"1px 2px"},children:e.jsx("div",{style:{height:"100%",width:u,backgroundColor:o,borderRadius:10}})});function m(){return t(s>0&&s<100),"calc("+s/100+" * 100%)"}}function N(s){return t(s>0&&s<100),s<50?b:s>=75?w:C}function p({name:s,children:n}){return e.jsxs(e.Fragment,{children:[e.jsx("em",{children:s}),": ",n]})}function A({entries:s,skip_links:n}){return e.jsx("div",{className:"values-table",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(o,{children:""}),e.jsx(o,{children:"Trans­parent"}),e.jsx(o,{children:"Fork­able"}),e.jsx(o,{children:"Access­ible"}),e.jsx(o,{children:"Sustai­nable"}),e.jsx(o,{children:"Inde­pendent"})]})}),e.jsx("tbody",{children:s.map((i,l)=>e.jsx(u,{...i},l))})]})});function u({modelName:i,transparent:l,forkable:d,accessible:j,independent:k,sustainable:v}){return e.jsxs("tr",{children:[e.jsx(a,{children:i}),e.jsx(a,{children:e.jsx(c,{val:l})}),e.jsx(a,{children:e.jsx(c,{val:d})}),e.jsx(a,{children:e.jsx(c,{val:j})}),e.jsx(a,{children:e.jsx(c,{val:v})}),e.jsx(a,{children:e.jsx(c,{val:k})})]})}function o({children:i,...l}){if(t(Object.keys(l).length===0),!i)return e.jsx("th",{});const d=i,j=n?d:e.jsx("a",{href:m(d),children:d});return e.jsx("th",{align:"center",children:j})}function m(i){return t(i.constructor===String),t(!i.includes("&shy;"),{value_name:i}),t(!i.includes("%C2%AD"),{value_name:i}),"/values"}function a({children:i}){return e.jsx("td",{align:"center",children:i})}function c({val:i}){return t(0<=i&&i<=1),i===1?e.jsx(z,{}):i===0?e.jsx(I,{}):e.jsx(L,{value:i*100})}}function R(){return e.jsx(e.Fragment,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("em",{children:"Transparent"}),": anyone can read the code."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Forkable"}),": anyone can modify the code and publish its own version."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Accessible"}),": anyone can use the code, no matter how much money at disposal."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Sustainable"}),": the project's developers are financially supported."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Independent"}),": the project isn't influenced by outside interests."]})]})})}function y(s){const n={li:"li",p:"p",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(A,{entries:[{modelName:e.jsx(e.Fragment,{children:"Open Source Pricing"}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Donations"]}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:.3},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Company Backed"]}),transparent:1,forkable:1,accessible:1,independent:0,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Open Core"]}),transparent:.7,forkable:.7,accessible:.7,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Public Source"]}),transparent:1,forkable:0,accessible:.45,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Closed Source"]}),transparent:0,forkable:0,accessible:.45,independent:1,sustainable:1}],skip_links:!0}),`
...
`,e.jsx(V,{style:{marginTop:60,marginBottom:45},children:"Paying for an Open Source framework isn't a bug, it's a feature: it's the guarantee the framework's interests are aligned with yours."}),`
