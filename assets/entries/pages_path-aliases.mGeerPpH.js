import{o as t,a as r}from"../chunks/chunk-CdUbzIK3.js";import{j as e}from"../chunks/chunk-AoU0HwcU.js";import{L as n}from"../chunks/chunk-e--FInO-.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as a}from"../chunks/chunk-BmMgx6lP.js";/* empty css                      *//* empty css                      */const d=[{pageSectionId:"vite-config-js",pageSectionLevel:2,pageSectionTitle:"`vite.config.js`"},{pageSectionId:"tsconfig-json",pageSectionLevel:2,pageSectionTitle:"`tsconfig.json`"},{pageSectionId:"package-json",pageSectionLevel:2,pageSectionTitle:"`package.json`"},{pageSectionId:"config-files",pageSectionLevel:2,pageSectionTitle:"Config files"}];function o(i){const s={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...i.components},{CodeSnippets:l}=s;return l||h("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"Instead of using relative import paths, which can be cumbersome, you can use path aliases. For example:"}),`
