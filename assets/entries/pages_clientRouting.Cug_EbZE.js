...
`,e.jsxs(n.p,{children:["You can skip Vike's client-side router from intercepting individual ",e.jsx(n.code,{children:"<a>"})," links by adding the ",e.jsx(n.code,{children:'data-vike="false"'})," attribute, e.g. ",e.jsx(n.code,{children:`<a data-vike="false" href="/some/url">Vike's client router won't intercept me</a>`}),"."]}),`
