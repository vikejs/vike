import{j as e,i as r,L as d,o}from"../chunks/chunk-BpkosQjM.js";import{L as s}from"../chunks/chunk-DpzyxQQZ.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-CChgn8K1.js";import{U as t}from"../chunks/chunk-BWxoV_yS.js";/* empty css                      *//* empty css                      */const a=[{pageSectionId:"scaffold-new-vike-solid-app",pageSectionLevel:2,pageSectionTitle:"Scaffold new `vike-solid` app"},{pageSectionId:"add-vike-solid-to-existing-vike-app",pageSectionLevel:2,pageSectionTitle:"Add `vike-solid` to existing Vike app"},{pageSectionId:"under-the-hood",pageSectionLevel:2,pageSectionTitle:"Under the hood"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function l(i){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(s,{href:"/extensions",children:"Vike extension"})," ",e.jsx(n.code,{children:"vike-solid"})," integrates ",e.jsx(n.a,{href:"https://solidjs.com",children:"Solid"})," in a full-fledged manner, providing a DX like a regular frontend framework such as Solid Start."]}),`
