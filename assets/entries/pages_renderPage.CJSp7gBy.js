import{o as d,a as p}from"../chunks/chunk-bXw5JTuY.js";import{j as e,d as o}from"../chunks/chunk-CXVZjUoF.js";import{L as n}from"../chunks/chunk-BJAHIKbp.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as t}from"../chunks/chunk-DMQXuT_6.js";import{M as h}from"../chunks/chunk-D-Y0rbPU.js";/* empty css                      */import{C as x}from"../chunks/chunk-CT2WdQXn.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-APiEl9g1.js";/* empty css                      */const j=[{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"usage",pageSectionLevel:2,pageSectionTitle:"Usage"},{pageSectionId:"optional",pageSectionLevel:2,pageSectionTitle:"Optional"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(l){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...t(),...l.components},{ChoiceGroup:r,CustomSelectsContainer:a}=s;return r||c("ChoiceGroup"),a||c("CustomSelectsContainer"),e.jsxs(e.Fragment,{children:[e.jsx(x,{env:"server",global:null}),`
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"renderPage()"})," function enables you to embed Vike into any server, see ",e.jsx(n,{href:"/integration#server-manual-integration",doNotInferSectionTitle:!0}),"."]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["We recommend using ",e.jsx(n,{href:"/server",children:e.jsx(s.code,{children:"+server.js"})})," instead of directly using ",e.jsx(s.code,{children:"renderPage()"})," yourself."]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
...
`,e.jsx(o,{text:"Express.js",path:"/packages/create-vike-core/boilerplate-react/server/index.js"}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(o,{text:"Express.js + TypeScript",path:"/packages/create-vike-core/boilerplate-vue-ts/server/index.ts"}),`
`]}),`
`,e.jsxs(s.li,{children:[`
...
`,e.jsx(a,{children:e.jsxs(r,{choiceGroup:{name:"codeLang",choices:["JavaScript","TypeScript"],default:"JavaScript",disabled:[],hidden:!1,lvl:0},children:[e.jsx(s.div,{"data-choice-value":"JavaScript",className:"choice",children:e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// server/index.js"})}),`
