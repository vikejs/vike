import{j as e,b as a,i as t,L as o,o as i}from"../chunks/chunk-BHFR-i-w.js";import{L as n}from"../chunks/chunk-CTkFNqbg.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-C-_bLe2s.js";/* empty css                      */const c=[{pageSectionId:"with-vike-server",pageSectionLevel:2,pageSectionTitle:"With `vike-server`"},{pageSectionId:"without-vike-server",pageSectionLevel:2,pageSectionTitle:"Without `vike-server`"},{pageSectionId:"ssg",pageSectionLevel:2,pageSectionTitle:"SSG"},{pageSectionId:"login-flow",pageSectionLevel:2,pageSectionTitle:"Login flow"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["You can make information about the authenticated user available to your pages and UI components by defining a ",e.jsxs(n,{href:"/pageContext#custom",children:["custom ",e.jsx(s.code,{children:"pageContext"})," property"]}),", such as ",e.jsx(s.code,{children:"pageContext.user"}),"."]}),`
