import{o as t,a as d}from"../chunks/chunk-C8N046DI.js";import{j as e}from"../chunks/chunk-Ch0sRy5R.js";import{L as n}from"../chunks/chunk-cySdRfqv.js";/* empty css                      *//* empty css                      */import{C as o}from"../chunks/chunk-BNVJRM3A.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as a}from"../chunks/chunk-CRr9echR.js";/* empty css                      *//* empty css                      *//* empty css                      */const c=[{pageSectionId:"for-all-files",pageSectionLevel:2,pageSectionTitle:"For all files"},{pageSectionId:"server-js",pageSectionLevel:3,pageSectionTitle:"`.server.js`"},{pageSectionId:"client-js",pageSectionLevel:3,pageSectionTitle:"`.client.js`"},{pageSectionId:"shared-js",pageSectionLevel:3,pageSectionTitle:"`.shared.js`"},{pageSectionId:"for-files",pageSectionLevel:2,pageSectionTitle:"For `+` files"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(l){const s={blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...a(),...l.components},{CodeSnippets:r}=s;return r||p("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Adding a filename suffix ",e.jsx(s.code,{children:".server.js"})," / ",e.jsx(s.code,{children:".client.js"})," / ",e.jsx(s.code,{children:".shared.js"})," to a file has following effect:"]}),`
