...
`,e.jsx(l,{name:"config"}),`
`,e.jsxs(n.p,{children:["All runtime information about the ",e.jsx(s,{href:"/config",children:"page's configuration"})," (for example the page's route and all its hooks)."]}),`
...
`,e.jsxs(t,{children:[e.jsxs(n.p,{children:["We recommend using ",e.jsxs(n.a,{href:"https://vite.dev/guide/env-and-mode.html#built-in-constants",children:["Vite's ",e.jsx(n.code,{children:"import.meta.env.SSR"})]})," instead."]}),e.jsxs(n.p,{children:["The advantage is that, when building client-side production code, Vite eliminates all code defined inside ",e.jsx(n.code,{children:"import.meta.env.SSR"})," if-blocks. Potentially saving a ",e.jsx(n.em,{children:"lot"})," of KBs."]}),e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// This import is also removed if it's used only inside import.meta.env.SSR if-blocks"})}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"  // Vite removes this code block from client-side production bundles"})}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(t,{children:[e.jsxs(n.p,{children:["While the following is more succinct, the server code isn't eliminated when building client-side production code (see warning ",e.jsx(s,{href:"#isClientSide",noWarning:!0,children:"here"}),"). Thus we recommend the approach using ",e.jsx(n.code,{children:"import.meta.env.SSR"})," and ",e.jsx(n.code,{children:"assert()"})," instead."]}),e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsxs(n.span,{"data-line":"",children:[e.jsx(n.span,{style:{color:"#D73A49"},children:"import"}),e.jsx(n.span,{style:{color:"#D73A49"},children:" type"}),e.jsx(n.span,{style:{color:"#24292E"},children:" { PageContext } "}),e.jsx(n.span,{style:{color:"#D73A49"},children:"from"}),e.jsx(n.span,{style:{color:"#032F62"},children:" 'vike/types'"})]}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
