import{j as e,i as l,L as r,o}from"../chunks/chunk-Bf3AjDJ9.js";import{L as s}from"../chunks/chunk-CU9zoEEB.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DZKvLVym.js";import{U as t}from"../chunks/chunk-BA3UMQW5.js";/* empty css                      *//* empty css                      *//* empty css                      */const d=[{pageSectionId:"page-data",pageSectionLevel:2,pageSectionTitle:"Page data"},{pageSectionId:"data",pageSectionLevel:3,pageSectionTitle:"`+data`"},{pageSectionId:"tools",pageSectionLevel:3,pageSectionTitle:"Tools"},{pageSectionId:"data-mutation-subsequent-data",pageSectionLevel:2,pageSectionTitle:"Data mutation & subsequent data"},{pageSectionId:"rpc",pageSectionLevel:3,pageSectionTitle:"RPC"},{pageSectionId:"api-routes",pageSectionLevel:3,pageSectionTitle:"API routes"},{pageSectionId:"graphql",pageSectionLevel:3,pageSectionTitle:"GraphQL"},{pageSectionId:"pre-rendering-ssg",pageSectionLevel:2,pageSectionTitle:"Pre-rendering (SSG)"},{pageSectionId:"global-data",pageSectionLevel:2,pageSectionTitle:"Global data"},{pageSectionId:"state-management",pageSectionLevel:2,pageSectionTitle:"State management"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(a){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"The usual recommendation is:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["For fetching the page's initial data, use ",e.jsxs(s,{href:"/data",children:["Vike's ",e.jsx(n.code,{children:"+data"})," hook"]}),"."]}),`
`,e.jsx(n.li,{children:"For data mutations and subsequent data (e.g., pagination), use a dedicated tool like tRPC or TanStack Query."}),`
`]}),`
`,e.jsx("h2",{id:"page-data",children:"Page data"}),`
`,e.jsxs(n.p,{children:["For fetching the page's initial data we generally recommend using Vike's ",e.jsx(n.code,{children:"+data"})," hook. But you can also use tools such as TanStack Query instead."]}),`
`,e.jsx(s,{href:"#data"}),`
`,e.jsx("br",{}),`
`,e.jsx(s,{href:"#tools"}),`
`,e.jsx("br",{}),`
`,e.jsx("h3",{id:"data",children:e.jsx("code",{children:"+data"})}),`
