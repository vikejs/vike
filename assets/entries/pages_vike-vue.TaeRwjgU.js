import{o as l,a as t}from"../chunks/chunk-NmatsbTo.js";import{j as e}from"../chunks/chunk-BrmjAz0L.js";import{L as s}from"../chunks/chunk-BKNaH_3H.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{U as d}from"../chunks/chunk-BHJXt8Vo.js";/* empty css                      *//* empty css                      *//* empty css                      */const o=[{pageSectionId:"scaffold-new-vike-vue-app",pageSectionLevel:2,pageSectionTitle:"Scaffold new `vike-vue` app"},{pageSectionId:"add-vike-vue-to-existing-vike-app",pageSectionLevel:2,pageSectionTitle:"Add `vike-vue` to existing Vike app"},{pageSectionId:"under-the-hood",pageSectionLevel:2,pageSectionTitle:"Under the hood"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(i){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(s,{href:"/extensions",children:"Vike extension"})," ",e.jsx(n.code,{children:"vike-vue"})," integrates ",e.jsx(n.a,{href:"https://vuejs.org",children:"Vue"})," in a full-fledged manner, providing a DX like a regular frontend framework such as Nuxt."]}),`
