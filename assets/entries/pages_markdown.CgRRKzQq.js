...
`]}),`
`]}),`
`,e.jsx(d,{children:e.jsxs(s.p,{children:["You may be tempted to use ",e.jsx(s.a,{href:"https://vitejs.dev/guide/features.html#glob-import",children:e.jsx(s.code,{children:"import.meta.glob()"})})," to retrieve the metadata of all pages, but we discourage this approach: loading all markdown files at once ",e.jsx(c,{}),"."]})}),`
