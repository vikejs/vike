import{o as a,a as t}from"../chunks/chunk-q7pFrboB.js";import{j as e,b as o}from"../chunks/chunk-BCGrQNKY.js";import{L as s}from"../chunks/chunk-BvbVecdL.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const i=[{pageSectionId:"with-vike-server",pageSectionLevel:2,pageSectionTitle:"With `vike-server`"},{pageSectionId:"without-vike-server",pageSectionLevel:2,pageSectionTitle:"Without `vike-server`"},{pageSectionId:"ssg",pageSectionLevel:2,pageSectionTitle:"SSG"},{pageSectionId:"login-flow",pageSectionLevel:2,pageSectionTitle:"Login flow"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["You can make information about the authenticated user available to your pages and UI components by defining a ",e.jsxs(s,{href:"/pageContext#custom",children:["custom ",e.jsx(n.code,{children:"pageContext"})," property"]}),", such as ",e.jsx(n.code,{children:"pageContext.user"}),"."]}),`
