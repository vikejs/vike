import{o as d,a as c}from"../chunks/chunk-bXw5JTuY.js";import{j as e}from"../chunks/chunk-CXVZjUoF.js";import{L as s}from"../chunks/chunk-BJAHIKbp.js";/* empty css                      */import{W as h}from"../chunks/chunk-DkV1GDTs.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as a}from"../chunks/chunk-DMQXuT_6.js";import{B as p}from"../chunks/chunk-BXdrgaw0.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-CREwLXjl.js";const j=[{pageSectionId:"what-changes-for-users",pageSectionLevel:2,pageSectionTitle:"What changes for users"},{pageSectionId:"what-is-universal-deploy",pageSectionLevel:2,pageSectionTitle:"What is Universal Deploy?"},{pageSectionId:"why-we-built-it-a-short-history",pageSectionLevel:2,pageSectionTitle:"Why we built it (a short history)"},{pageSectionId:"collaborating-with-the-vite-ecosystem",pageSectionLevel:2,pageSectionTitle:"Collaborating with the Vite ecosystem"},{pageSectionId:"collaborating-with-tencent-edgeone",pageSectionLevel:2,pageSectionTitle:"Collaborating with Tencent EdgeOne"},{pageSectionId:"try-it-out",pageSectionLevel:2,pageSectionTitle:"Try it out"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function o(r){const n={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...r.components},{ChoiceGroup:t,CustomSelectsContainer:i}=n;return t||l("ChoiceGroup"),i||l("CustomSelectsContainer"),e.jsxs(e.Fragment,{children:[e.jsx(p,{authors:["magne4000","brillout"],date:new Date("2026-04-20")}),`
`,e.jsx(h,{children:e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Early draft"}),": This blog post is an early draft, and Universal Deploy is going to be officially announced next week (ETA: April 20). That said, you can already use ",e.jsx(s,{href:"/server",children:e.jsx(n.code,{children:"+server"})})," today (starting from ",e.jsx(n.code,{children:"0.4.257"}),")."]})}),`
`,e.jsxs(n.p,{children:["Today, we are thrilled to introduce ",e.jsx(n.a,{href:"https://github.com/universal-deploy/universal-deploy",children:"Universal Deploy"})," — a new infrastructure to deploy Vite apps anywhere with zero configuration."]}),`
...
`,e.jsxs(n.p,{children:[e.jsxs(n.strong,{children:["This means ",e.jsx(n.code,{children:"vike-photon"})," is now deprecated"]}),": everything it did is now part of Vike core or Universal Deploy, with a simpler DX and no extra packages to install."]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Manual integration via ",e.jsx(s,{href:"/renderPage",children:e.jsx(n.code,{children:"renderPage()"})})," is still supported and remains unchanged. We care about both zero-config integrations and manual integrations — ensuring both workflows are fully supported and maintained."]}),`
`]}),`
...
`,e.jsx(n.p,{children:"Universal Deploy is the third — and we hope last — iteration of the same idea."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Universal Deploy"})," ",e.jsx(n.em,{children:"(April 2026)"})," takes that one step further. Photon was framework-agnostic, but it was still its own opinionated stack. The conversations sparked by ",e.jsx(n.a,{href:"https://github.com/vitejs/vite/discussions/20907",children:"Netlify's RFC on Vite"})," — and the ",e.jsx(n.a,{href:"https://github.com/vitejs/ecosystem/issues/3",children:"related ecosystem RFC"})," about aligning on Vite's intended scope to allow framework-agnostic provider plugins — made it clear that what the ecosystem really needed was something even smaller and even more neutral: a tiny convention layer that ",e.jsx(n.em,{children:"everyone"})," — frameworks, deployment providers, and Vite itself — could adopt without buying into a particular implementation."]}),`
...
`,e.jsx("h2",{id:"collaborating-with-the-vite-ecosystem",children:"Collaborating with the Vite ecosystem"}),`
`,e.jsxs(n.p,{children:["Universal Deploy is a direct response to ",e.jsx(n.a,{href:"https://github.com/vitejs/vite/discussions/20907",children:"Netlify's RFC"}),". Specifically, it tackles two of the issues raised in the RFC:"]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Routing metadata"})," — how does it know which routes go where, and which methods they handle?"]}),`
`]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"@universal-deploy/*"})," packages are a concrete answer to those questions, and we're working to bring these conventions to the broader Vite and JavaScript ecosystem (not just to Universal Deploy)."]}),`
`,e.jsx(n.p,{children:"We're continuing to collaborate with the Vite team and ecosystem. The more participants converge on the same low-level conventions, the better it gets for everyone."}),`
...
`]}),`
`,e.jsx(n.p,{children:"We believe it's just the beginning of our collaboration and we're looking forward to what's next 🚀"}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://github.com/vitejs/vite/discussions/20907",children:"Netlify's RFC on Vite"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://github.com/vitejs/ecosystem/issues/3",children:"RFC: Align on Vite's intended scope to allow for framework-agnostic provider plugins"})}),`
`,e.jsxs(n.li,{children:[`
...
`]}),`
`]})]})}function x(r={}){const{wrapper:n}={...a(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(o,{...r})}):o(r)}function l(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const y=Object.freeze(Object.defineProperty({__proto__:null,default:x,pageSectionsExport:j},Symbol.toStringTag,{value:"Module"})),z={hasServerOnlyHook:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!1}},isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},guardEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:c}},onCreatePageContext:{type:"cumulative",definedAtData:[{filePathToShowToUser:"@brillout/docpress/renderer/onCreatePageContext",fileExportPathToShowToUser:[]}],valueSerialized:[{type:"pointer-import",value:d}]},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/blog/universal-deploy/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:y}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}}};export{z as configValuesSerialized};
