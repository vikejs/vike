import{j as e,i as o,L as c,o as d}from"../chunks/chunk-BwoMe8xD.js";import{L as s}from"../chunks/chunk-kKZrYxcb.js";/* empty css                      */import{W as a}from"../chunks/chunk-BWuI-fJv.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DEIn0ftr.js";/* empty css                      *//* empty css                      *//* empty css                      */const l=h("pageContext");function h(r){return function({name:t}){return e.jsx("h3",{id:t,children:e.jsxs("code",{children:[r,".",t]})})}}const p=[{pageSectionId:"built-in",pageSectionLevel:2,pageSectionTitle:"Built-in"},{pageSectionId:"custom",pageSectionLevel:2,pageSectionTitle:"Custom"},{pageSectionId:"faq",pageSectionLevel:2,pageSectionTitle:"FAQ"},{pageSectionId:"can-i-mutate-pagecontext",pageSectionLevel:3,pageSectionTitle:"Can I mutate `pageContext`?"},{pageSectionId:"can-i-use-pagecontext-as-a-ui-store",pageSectionLevel:3,pageSectionTitle:"Can I use `pageContext` as a UI store?"},{pageSectionId:"can-i-check-whether-ssr-is-enabled",pageSectionLevel:3,pageSectionTitle:"Can I check whether SSR is enabled?"},{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"basics",pageSectionLevel:3,pageSectionTitle:"Basics"},{pageSectionId:"narrowing-down",pageSectionLevel:3,pageSectionTitle:"Narrowing down"},{pageSectionId:"extend",pageSectionLevel:3,pageSectionTitle:"Extend"},{pageSectionId:"server-routing",pageSectionLevel:3,pageSectionTitle:"Server Routing"},{pageSectionId:"lifecycle",pageSectionLevel:2,pageSectionTitle:"Lifecycle"},{pageSectionId:"server",pageSectionLevel:3,pageSectionTitle:"Server"},{pageSectionId:"client",pageSectionLevel:3,pageSectionTitle:"Client"},{pageSectionId:"pre-rendering",pageSectionLevel:3,pageSectionTitle:"Pre-rendering"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(r){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"pageContext"})," object provides contextual information about the current page."]}),`
...
`,e.jsxs(n.p,{children:["Runtime information about your app, see ",e.jsx(s,{href:"/getGlobalContext"}),"."]}),`
`,e.jsx(l,{name:"isPageContext"}),`
`,e.jsxs(n.p,{children:["Always ",e.jsx(n.code,{children:"true"}),", useful for distinguishing ",e.jsx(n.code,{children:"pageContext"})," from other objects and narrowing down TypeScript unions."]}),`
