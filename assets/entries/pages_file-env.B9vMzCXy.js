import{o as t,a as d}from"../chunks/chunk-B0ujB0aw.js";import{j as e}from"../chunks/chunk-Bk7znnMF.js";import{L as n}from"../chunks/chunk-plGvigrJ.js";/* empty css                      *//* empty css                      */import{C as c}from"../chunks/chunk-Cezguapt.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as a}from"../chunks/chunk-CkuOMFbq.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const o=[{pageSectionId:"for-all-files",pageSectionLevel:2,pageSectionTitle:"For all files"},{pageSectionId:"server-js",pageSectionLevel:3,pageSectionTitle:"`.server.js`"},{pageSectionId:"client-js",pageSectionLevel:3,pageSectionTitle:"`.client.js`"},{pageSectionId:"for-files",pageSectionLevel:2,pageSectionTitle:"For `+` files"},{pageSectionId:"ssr-js",pageSectionLevel:3,pageSectionTitle:"`.ssr.js`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(l){const s={blockquote:"blockquote",code:"code",div:"div",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...l.components},{ChoiceGroup:r}=s;return r||p("ChoiceGroup"),e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["For any file, adding ",e.jsx(s.code,{children:".server.js"})," / ",e.jsx(s.code,{children:".client.js"})," ",e.jsx(s.strong,{children:"guarantees"})," the environment in which it's loaded."]}),`
