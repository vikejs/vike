import{j as e,i as l,L as a,o as i}from"../chunks/chunk-Bf3AjDJ9.js";import{L as s}from"../chunks/chunk-CU9zoEEB.js";/* empty css                      */import{C as o}from"../chunks/chunk-D9Cuy2Nu.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DZKvLVym.js";/* empty css                      *//* empty css                      */import{M as d}from"../chunks/chunk-D5GvQAJk.js";/* empty css                      *//* empty css                      */const c=[{pageSectionId:"ssr",pageSectionLevel:2,pageSectionTitle:"SSR"},{pageSectionId:"extensions",pageSectionLevel:3,pageSectionTitle:"Extensions"},{pageSectionId:"manual-integration",pageSectionLevel:3,pageSectionTitle:"Manual integration"}];function r(t){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.blockquote,{children:[`
...
`,e.jsxs(n.p,{children:["That said, there are use cases where it can make sense. Most notably, when ",e.jsx(s,{href:"/data-fetching#page-data",children:"the page's initial data"})," is subject to mutations: it can make sense to have your components access the data through the store rather than directly. In that case, you must initialize the store on the server-side so that components can access the data through the store during Server-Side Rendering (SSR)."]}),`
`,e.jsx(n.p,{children:"For example, with a to-do list app, the initial to-do list is likely to change — tasks can be added, removed, or updated. Using a store ensures components stay in sync with those changes. (Note that this isn't a realistic example because a to-do list app usually doesn't need SSR.)"}),`
`]}),`
