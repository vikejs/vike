import{o as i,a as t}from"../chunks/chunk-BQuxccGo.js";import{j as e}from"../chunks/chunk-COSJmPUs.js";import{L as n}from"../chunks/chunk-BCHPCi_P.js";/* empty css                      *//* empty css                      */import{C as a}from"../chunks/chunk-MmXBf-uU.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const o=[{pageSectionId:"for-all-files",pageSectionLevel:2,pageSectionTitle:"For all files"},{pageSectionId:"server-js",pageSectionLevel:3,pageSectionTitle:"`.server.js`"},{pageSectionId:"client-js",pageSectionLevel:3,pageSectionTitle:"`.client.js`"},{pageSectionId:"shared-js",pageSectionLevel:3,pageSectionTitle:"`.shared.js`"},{pageSectionId:"for-files",pageSectionLevel:2,pageSectionTitle:"For `+` files"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Adding a filename suffix ",e.jsx(s.code,{children:".server.js"})," / ",e.jsx(s.code,{children:".client.js"})," / ",e.jsx(s.code,{children:".shared.js"})," to a file has following effect:"]}),`
