...
`,e.jsxs(n.p,{children:["To define properties only for the server- or client-side, define the interfaces ",e.jsx(n.code,{children:"Vike.PageContextServer"})," or ",e.jsx(n.code,{children:"Vike.PageContextClient"})," instead."]}),`
