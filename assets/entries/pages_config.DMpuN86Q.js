...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"} "}),e.jsx(s.span,{style:{color:"#D73A49"},children:"satisfies"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" Config"})]})]})})}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["To set defaults for ",e.jsx(n,{href:"#cumulative",children:"cumulative configurations"}),", see:"]}),`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsxs(s.blockquote,{children:[`
`,e.jsx(s.p,{children:"To configure the inheritance behavior of cumulative settings, see:"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsxs(s.a,{href:"https://github.com/vikejs/vike/issues/1692",children:["#1692 - New settings ",e.jsx(s.code,{children:"clear"})," and ",e.jsx(s.code,{children:"default"})," for controlling inheritance of cumulative configs"]})}),`
`]}),`
`]}),`
`,e.jsx("h3",{id:"global",children:"Global"}),`
`,e.jsxs(s.p,{children:["A configuration is called ",e.jsx(s.em,{children:"global"})," when it always applies to all pages. Thus, config inheritance doesn't apply to global configs."]}),`
`,e.jsxs(s.p,{children:["For example, ",e.jsx(n,{href:"/base-url",children:"Base URL settings"})," apply globally to your app."]}),`
